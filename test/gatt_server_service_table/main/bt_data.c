...
char* readDataCharacteristic6(void) {
    char mag3Data[200];
    float accX = 5.1f, accY = 5.2f, accZ = 5.3f, magX = 6.1f, magY = 6.2f, magZ = 6.3f, temp = 38.6f;
    snprintf(mag3Data, sizeof(mag3Data), "[MAG2-ACCX, %.2f, MAG2-ACCY, %.2f, MAG2-ACCZ, %.2f, MAG2-MAGX, %.2f, MAG2-MAGY, %.2f, MAG2-MAGZ, %.2f, MAG2-TEMP, %.2f]", 
             accX, accY, accZ, magX, magY, magZ, temp);
    return mag3Data;
}
...
char* readDataCharacteristic14(void) {
    char miscData[200];
    float wing1 = 5.1f, wing2 = 5.2f, wing3 = 5.3f, wing4 = 6.1f, throttle = 6.2f, vTemp = 6.3f, voltage = 38.6f, current = 3.3f, batt_percent = 7.7f;
    snprintf(miscData, sizeof(miscData), "[WING1, %.2f, WING2, %.2f, WING3, %.2f, WING4, %.2f, THROTTLE, %.2f, VTEMP, %.2f, VOLTAGE, %.2f, CURRENT, %.2f, BATT_PERCENT, %.2f]", 
             wing1, wing2, wing3, wing4, throttle, vTemp, voltage, current, batt_percent);
    return miscData;
}

char* readDataCharacteristic15(void) {
    char settingsData[200];
...
char* readDataCharacteristic16(void) {
    return "Data not implemented";
}

char* readDataCharacteristic17(void) {
    return "Data not implemented";
}

char* readDataCharacteristic18(void) {
    return "Data not implemented";
}

char* readDataCharacteristic19(void) {
    return "Data not implemented";
}

char* readDataCharacteristic20(void) {
    return "Data not implemented";
}