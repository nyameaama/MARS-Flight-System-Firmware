...
uint32_t
spiFrequencyToClockDiv(uint32_t freq)
{
...
class EspHal : public RadioLibHal
{
  public:
    ...
    void
    attachInterrupt(uint32_t interruptNum, void (*interruptCb)(void), uint32_t mode) override
    {
        ...
        // this uses function typecasting, which is not defined when the functions have different
        // signatures untested and might not work
