 ...
 * @param txt           text to display in the cell. It will be copied and saved so this variable is
 * not required after this function call.
 ...
 * @param obj       pointer to a table object
 * @param row       pointer to variable to store the selected row (LV_TABLE_CELL_NONE: if no cell
 * selected)
 * @param col       pointer to variable to store the selected column  (LV_TABLE_CELL_NONE: if no
 * cell selected)
 */
