...
/**
 * Set the cell of an object. The object's parent needs to have grid layout, else nothing will
 * happen
 ...
 */
void lv_obj_set_grid_cell(lv_obj_t* obj, lv_grid_align_t column_align, uint8_t col_pos,
...
void lv_obj_set_style_grid_row_dsc_array(lv_obj_t* obj, const lv_coord_t value[],
...
static inline lv_coord_t
lv_obj_get_style_grid_cell_row_pos(const lv_obj_t* obj, uint32_t part)
{
...
static inline lv_coord_t
lv_obj_get_style_grid_cell_x_align(const lv_obj_t* obj, uint32_t part)
{
...
static inline lv_coord_t
lv_obj_get_style_grid_cell_y_align(const lv_obj_t* obj, uint32_t part)
{
