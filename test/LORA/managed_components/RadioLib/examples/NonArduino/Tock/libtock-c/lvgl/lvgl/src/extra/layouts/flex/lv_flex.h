 ...
 * @param flex pointer: to a flex layout descriptor
 * @param main_place where to place the items on main axis (in their track). Any value of
 * `lv_flex_align_t`.
 * @param cross_place where to place the item in their track on the cross axis.
 * `LV_FLEX_ALIGN_START/END/CENTER`
 * @param track_place where to place the tracks in the cross direction. Any value of
 * `lv_flex_align_t`.
 */
...
lv_obj_get_style_flex_grow(const lv_obj_t* obj, uint32_t part)
{
