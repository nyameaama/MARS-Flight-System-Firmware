...
__attribute__((warn_unused_result)) syscall_return_t command(uint32_t driver, uint32_t command,
                                                             int arg1, int arg2);
...
__attribute__((warn_unused_result)) subscribe_return_t subscribe(uint32_t driver,
                                                                 uint32_t subscribe,
                                                                 subscribe_upcall uc,
                                                                 void* userdata);

__attribute__((warn_unused_result)) allow_rw_return_t allow_readwrite(uint32_t driver,
                                                                      uint32_t allow, void* ptr,
                                                                      size_t size);

__attribute__((warn_unused_result)) allow_userspace_r_return_t allow_userspace_read(uint32_t driver,
                                                                                    uint32_t allow,
                                                                                    void* ptr,
                                                                                    size_t size);

__attribute__((warn_unused_result)) allow_ro_return_t allow_readonly(uint32_t driver,
                                                                     uint32_t allow,
