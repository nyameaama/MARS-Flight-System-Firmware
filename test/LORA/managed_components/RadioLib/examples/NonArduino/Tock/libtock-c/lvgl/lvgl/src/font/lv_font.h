...
typedef struct _lv_font_t
{
    ...
    bool (*get_glyph_dsc)(const struct _lv_font_t*, lv_font_glyph_dsc_t*, uint32_t letter,
    ...
    int8_t underline_position;  /**< Distance between the top of the underline and base line (< 0
                                   means below the base line)*/
...
lv_font_get_line_height(const lv_font_t* font_p)
{
...
/**
 * Just a wrapper around LV_FONT_DEFAULT because it might be more convenient to use a function is
 * some cases
