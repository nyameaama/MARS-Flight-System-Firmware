...
enum
{
    ...
    LV_BTNMATRIX_CTRL_CLICK_TRIG = 0x0100, /**< 1: Send LV_EVENT_VALUE_CHANGE on CLICK, 0: Send
...
typedef struct
{
    ...
    uint16_t btn_id_sel;            /*Index of the active button (being pressed/released etc) or
