 ...
 */
void lv_chart_set_axis_tick(lv_obj_t* obj, lv_chart_axis_t axis, lv_coord_t major_len,
                            lv_coord_t minor_len, lv_coord_t major_cnt, lv_coord_t minor_cnt,
 ...
 */
void lv_chart_get_point_pos_by_id(lv_obj_t* obj, lv_chart_series_t* ser, uint16_t id,
                                  lv_point_t* p_out);
 ...
 * @param dir       direction of the cursor. `LV_DIR_RIGHT/LEFT/TOP/DOWN/HOR/VER/ALL`. OR-ed values
 * are possible
 ...
 * @param obj       pointer to chart object
 * @param ser       pointer to a data series on 'chart'
 * @param value     the new value for all points. `LV_CHART_POINT_DEF` can be used to hide the
 * points.
 */
 ...
 */
void lv_chart_set_next_value2(lv_obj_t* obj, lv_chart_series_t* ser, lv_coord_t x_value,
                              lv_coord_t y_value);
 ...
 * @param y_value   the new Y value of the next data
 */
void lv_chart_set_value_by_id2(lv_obj_t* obj, lv_chart_series_t* ser, uint16_t id,
                               lv_coord_t x_value, lv_coord_t y_value);

/**
 * Set an external array for the y data points to use for the chart
 * NOTE: It is the users responsibility to make sure the `point_cnt` matches the external array
 * size.
 * @param obj       pointer to a chart object
 * @param ser       pointer to a data series on 'chart'
 ...
 * @param obj       pointer to a chart object
 * @return          the index of the point [0 .. point count] or LV_CHART_POINT_ID_NONE if no point
 * is being pressed
 */
