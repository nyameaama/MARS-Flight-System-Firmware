...
/**
 * Get the X and Y coordinates where the scrolling will end for this object if a scrolling animation
 * is in progress. In no scrolling animation give the current `x` or `y` scroll position.
 * @param obj       pointer to an object
