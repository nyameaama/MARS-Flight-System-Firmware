 ...
 * The image will be left open meaning if the image decoder open callback allocated memory then it
 * will remain. The image is closed if a new image is opened and the new image takes its place in
 * the cache.
