/*
  ...
  3. Example sketches MUST be working correctly and MUST be stable enough to run for prolonged
  periods of time.
...
/*
  ...
  2 - Variable map: defines variables inside register. This functions as a bit range map for a
  specific register. Bit range (MSB and LSB) as well as short description for each variable MUST be
...
// <module_name>_REG_<register_name>                                            MSB   LSB
// DESCRIPTION
...
/*
  ...
  1 - PhysicalLayer: In case the module implements methods for OSI physical layer control (e.g.
  SX127x). 2 - Common class: In case the module further specifies some more generic class (e.g.
  SX127x/SX1278)
*/
class<module_name>
{
  ...
  private:
    ...
    */
    ...
    /*
      ...
      Usually, these are variables for saving module configuration, or methods that do not have to
