...
//                        - Morse code representation is saved LSb first, using additional bit as
//                        guard
//                        - position in array corresponds ASCII code minus
//                        RADIOLIB_MORSE_ASCII_OFFSET
//                        - ASCII characters marked RADIOLIB_MORSE_UNSUPPORTED do not have ITU-R
//                        M.1677-1 equivalent
  ...
  public:
    ...
    */
    ...
    /*!
      ...
      (in AFSK mode) \param speed Coding speed in words per minute. \returns \ref status_codes
    */
