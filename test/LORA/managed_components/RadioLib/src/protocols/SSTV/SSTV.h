...
{
    /*!
      \brief Tone type: GENERIC for sync and porch tones, SCAN_GREEN, SCAN_BLUE and SCAN_RED for
      scan lines.
    */
    enum
    {
...
struct SSTVMode_t
{
    ...
    */
    ...
    /*!
      \brief Sequence of tones in each transmission line. This is used to create the correct
      encoding sequence.
    */
    tone_t tones[8];
};
