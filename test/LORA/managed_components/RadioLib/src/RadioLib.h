...
/*!
  ...
  Some methods (mainly configuration) are also overridden in derived classes, such as SX1272,
  SX1278, RFM96 etc. for SX127x.\n \ref status_codes have their own page.\n Some modules implement
  methods of one or more compatibility layers, loosely based on the ISO/OSI model:
...
#pragma message(                                                                                                                                \
    "\nRadioLib Debug Info\nVersion:  \"" RADIOLIB_VALUE(RADIOLIB_VERSION_MAJOR) "." RADIOLIB_VALUE(RADIOLIB_VERSION_MINOR) "." RADIOLIB_VALUE( \
        RADIOLIB_VERSION_PATCH) "." RADIOLIB_VALUE(RADIOLIB_VERSION_EXTRA) "\"\n"                                                               \
                                                                           "Platform: " RADIOLIB_VALUE(                                         \
                                                                               RADIOLIB_PLATFORM) "\n"                                          \
                                                                                                  "Compiled: " RADIOLIB_VALUE(                  \
