...
#define RADIOLIB_NRF24_MASK_RX_DR_IRQ_OFF \
    0b01000000  //  6     6   RX_DR will not be reflected on IRQ pin
#define RADIOLIB_NRF24_MASK_RX_DR_IRQ_ON \
    0b00000000  //  6     6   RX_DR will be reflected on IRQ pin as active low (default)
#define RADIOLIB_NRF24_MASK_TX_DS_IRQ_OFF \
    0b00100000  //  5     5   TX_DS will not be reflected on IRQ pin
#define RADIOLIB_NRF24_MASK_TX_DS_IRQ_ON \
    0b00000000  //  5     5   TX_DS will be reflected on IRQ pin as active low (default)
#define RADIOLIB_NRF24_MASK_MAX_RT_IRQ_OFF \
    0b00010000  //  4     4   MAX_RT will not be reflected on IRQ pin
#define RADIOLIB_NRF24_MASK_MAX_RT_IRQ_ON \
    0b00000000  //  4     4   MAX_RT will be reflected on IRQ pin as active low (default)
...
#define RADIOLIB_NRF24_ARD \
    0b00000000  //  7     4   auto retransmit delay: t[us] = (NRF24_ARD + 1) * 250 us
#define RADIOLIB_NRF24_ARC_OFF \
    0b00000000  //  3     0   auto retransmit count: auto retransmit disabled
#define RADIOLIB_NRF24_ARC \
    0b00000011  //  3     0                          up to 3 retransmits on AA fail (default)

// RADIOLIB_NRF24_REG_RF_CH
#define RADIOLIB_NRF24_RF_CH \
    0b00000010  //  6     0   RF channel: f_CH[MHz] = 2400 MHz + NRF24_RF_CH

// RADIOLIB_NRF24_REG_RF_SETUP
#define RADIOLIB_NRF24_CONT_WAVE_OFF \
    0b00000000  //  7     7   continuous carrier transmit: disabled (default)
...
#define RADIOLIB_NRF24_MAX_RT \
    0b00010000  //  4     4   maximum number of retransmits reached (must be cleared to continue)
...
#define RADIOLIB_NRF24_RP_BELOW_64_DBM \
    0b00000000  //  0     0   received power in the current channel: less than -64 dBm
#define RADIOLIB_NRF24_RP_ABOVE_64_DBM \
    0b00000001  //  0     0                                            more than -64 dBm
...
#define RADIOLIB_NRF24_DPL_P5_OFF \
    0b00000000  //  5     5   dynamic payload length on pipe 5: disabled (default)
#define RADIOLIB_NRF24_DPL_P5_ON 0b00100000  //  5     5                                     enabled
#define RADIOLIB_NRF24_DPL_P4_OFF \
    0b00000000  //  4     4   dynamic payload length on pipe 4: disabled (default)
#define RADIOLIB_NRF24_DPL_P4_ON 0b00010000  //  4     4                                     enabled
#define RADIOLIB_NRF24_DPL_P3_OFF \
    0b00000000  //  3     3   dynamic payload length on pipe 3: disabled (default)
#define RADIOLIB_NRF24_DPL_P3_ON 0b00001000  //  3     3                                     enabled
#define RADIOLIB_NRF24_DPL_P2_OFF \
    0b00000000  //  2     2   dynamic payload length on pipe 2: disabled (default)
#define RADIOLIB_NRF24_DPL_P2_ON 0b00000100  //  2     2                                     enabled
#define RADIOLIB_NRF24_DPL_P1_OFF \
    0b00000000  //  1     1   dynamic payload length on pipe 1: disabled (default)
#define RADIOLIB_NRF24_DPL_P1_ON 0b00000010  //  1     1                                     enabled
#define RADIOLIB_NRF24_DPL_P0_OFF \
    0b00000000  //  0     0   dynamic payload length on pipe 0: disabled (default)
...
#define RADIOLIB_NRF24_ACK_PAY_OFF \
    0b00000000  //  1     1   payload with ACK packets: disabled (default)
#define RADIOLIB_NRF24_ACK_PAY_ON 0b00000010  //  1     1                             enabled
#define RADIOLIB_NRF24_DYN_ACK_OFF \
    0b00000000                                //  0     0   payloads without ACK: disabled (default)
...
class nRF24 : public PhysicalLayer
{
  public:
    ...
    */
    int16_t begin(int16_t freq = RADIOLIB_NRF24_DEFAULT_FREQ,
                  int16_t dr = RADIOLIB_NRF24_DEFAULT_DR, int8_t pwr = RADIOLIB_NRF24_DEFAULT_POWER,
    ...
    */
    ...
    /*!
      \brief Interrupt-driven binary transmit method. IRQ will be activated when full packet is
      transmitted. Overloads for string-based transmissions are implemented in PhysicalLayer. \param
      data Binary data to be sent. \param len Number of bytes to send. \param addr Dummy address
      parameter, to ensure PhysicalLayer compatibility. \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      received. Must be known in advance for binary transmissions. \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      \brief Sets address width of transmit and receive pipes in bytes. Allowed values are 3, 4 or 5
      bytes. \param addrWidth Address width to be set in bytes. \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      \param pipeNum Number of pipe to which the address shall be set. Allowed values range from 2
      to 5. \param addrByte LSB of address from which %nRF24 shall receive new packets on the
      specified pipe. \returns \ref status_codes
    */
  ...
  protected:
    ...
    void SPItransfer(uint8_t cmd, bool write = false, uint8_t* dataOut = NULL,
                     uint8_t* dataIn = NULL, uint8_t numBytes = 0);
