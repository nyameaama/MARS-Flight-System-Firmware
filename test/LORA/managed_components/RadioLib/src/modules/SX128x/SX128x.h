...
#define RADIOLIB_SX128X_STATUS_MODE_STDBY_XOSC \
    0b01100000                                           //  7     5                      STDBY_XOSC
...
#define RADIOLIB_SX128X_STATUS_DATA_AVAILABLE \
    0b00001000                                         //  4     2                   data available
...
#define RADIOLIB_SX128X_STATUS_CMD_FAILED \
    0b00010100  //  4     2                   failed to execute
#define RADIOLIB_SX128X_STATUS_TX_DONE \
    0b00011000                                  //  4     2                   transmission finished
...
#define RADIOLIB_SX128X_SLEEP_DATA_BUFFER_FLUSH \
    0b00000000  //  1     1   data buffer behavior in sleep mode: flush
#define RADIOLIB_SX128X_SLEEP_DATA_BUFFER_RETAIN \
    0b00000010  //  1     1                                       retain
...
#define RADIOLIB_SX128X_TX_TIMEOUT_NONE \
    0x0000  //  15    0   Tx timeout duration: no timeout (Tx single mode)

// RADIOLIB_SX128X_CMD_SET_RX
#define RADIOLIB_SX128X_RX_TIMEOUT_NONE \
    0x0000  //  15    0   Rx timeout duration: no timeout (Rx single mode)
#define RADIOLIB_SX128X_RX_TIMEOUT_INF \
    0xFFFF  //  15    0                        infinite (Rx continuous mode)
...
#define RADIOLIB_SX128X_BLE_GFSK_BT_OFF \
    0x00  //  7     0   GFSK Gaussian filter BT product: filter disabled
#define RADIOLIB_SX128X_BLE_GFSK_BT_1_0 0x10  //  7     0                                    1.0
#define RADIOLIB_SX128X_BLE_GFSK_BT_0_5 0x20  //  7     0                                    0.5
#define RADIOLIB_SX128X_FLRC_BR_1_300_BW_1_2 \
    0x45  //  7     0   FLRC bit rate and bandwidth setting: 1.3 Mbps   1.2 MHz
#define RADIOLIB_SX128X_FLRC_BR_1_000_BW_1_2 \
    0x69  //  7     0                                        1.04 Mbps  1.2 MHz
#define RADIOLIB_SX128X_FLRC_BR_0_650_BW_0_6 \
    0x86  //  7     0                                        0.65 Mbps  0.6 MHz
#define RADIOLIB_SX128X_FLRC_BR_0_520_BW_0_6 \
    0xAA  //  7     0                                        0.52 Mbps  0.6 MHz
#define RADIOLIB_SX128X_FLRC_BR_0_325_BW_0_3 \
    0xC7  //  7     0                                        0.325 Mbps 0.3 MHz
#define RADIOLIB_SX128X_FLRC_BR_0_260_BW_0_3 \
    0xEB  //  7     0                                        0.260 Mbps 0.3 MHz
...
#define RADIOLIB_SX128X_FLRC_BT_OFF \
    0x00  //  7     0   FLRC Gaussian filter BT product: filter disabled
...
#define RADIOLIB_SX128X_GFSK_FLRC_SYNC_WORD_1 \
    0x10  //  7     0                             sync word 1
#define RADIOLIB_SX128X_GFSK_FLRC_SYNC_WORD_2 \
    0x20  //  7     0                             sync word 2
#define RADIOLIB_SX128X_GFSK_FLRC_SYNC_WORD_1_2 \
    0x30  //  7     0                             sync words 1 and 2
#define RADIOLIB_SX128X_GFSK_FLRC_SYNC_WORD_3 \
    0x40  //  7     0                             sync word 3
#define RADIOLIB_SX128X_GFSK_FLRC_SYNC_WORD_1_3 \
    0x50  //  7     0                             sync words 1 and 3
#define RADIOLIB_SX128X_GFSK_FLRC_SYNC_WORD_2_3 \
    0x60  //  7     0                             sync words 2 and 3
#define RADIOLIB_SX128X_GFSK_FLRC_SYNC_WORD_1_2_3 \
    0x70  //  7     0                             sync words 1, 2 and 3
#define RADIOLIB_SX128X_GFSK_FLRC_PACKET_FIXED \
    0x00  //  7     0   GFSK/FLRC packet length mode: fixed
#define RADIOLIB_SX128X_GFSK_FLRC_PACKET_VARIABLE \
    0x20                                        //  7     0                                 variable
...
#define RADIOLIB_SX128X_GFSK_FLRC_CRC_3_BYTE \
    0x30  //  7     0                         3 bytes (FLRC only)
...
#define RADIOLIB_SX128X_BLE_PAYLOAD_LENGTH_MAX_31 \
    0x00  //  7     0   BLE maximum payload length: 31 bytes
#define RADIOLIB_SX128X_BLE_PAYLOAD_LENGTH_MAX_37 \
    0x20  //  7     0                               37 bytes
#define RADIOLIB_SX128X_BLE_PAYLOAD_LENGTH_TEST \
    0x40  //  7     0                               63 bytes (test mode)
...
#define RADIOLIB_SX128X_BLE_PRBS_9 \
    0x00  //  7     0   BLE test payload contents: PRNG sequence using x^9 + x^5 + x
...
#define RADIOLIB_SX128X_BLE_PRBS_15 \
    0x0C  //  7     0                              PRNG sequence using x^15 + x^14 + x^13 + x^12 +
          //  x^2 + x + 1
...
#define RADIOLIB_SX128X_BLE_EYESHORT_INV \
...
#define RADIOLIB_SX128X_PACKET_STATUS_SYNC_ERROR \
    0b01000000  //  6     6   packet status errors byte: sync word error
#define RADIOLIB_SX128X_PACKET_STATUS_LENGTH_ERROR \
    0b00100000  //  5     5                              packet length error
#define RADIOLIB_SX128X_PACKET_STATUS_CRC_ERROR \
...
#define RADIOLIB_SX128X_PACKET_STATUS_RX_PID_ERROR \
    0b00010000  //  4     4                              PID field error
#define RADIOLIB_SX128X_PACKET_STATUS_PACKET_SENT \
    0b00000001  //  0     0                              packet sent
#define RADIOLIB_SX128X_PACKET_STATUS_SYNC_DET_ERROR \
    0b00000000  //  2     0   packet status sync byte: sync word detection error
#define RADIOLIB_SX128X_PACKET_STATUS_SYNC_DET_1 \
    0b00000001  //  2     0                            detected sync word 1
#define RADIOLIB_SX128X_PACKET_STATUS_SYNC_DET_2 \
    0b00000010  //  2     0                            detected sync word 2
#define RADIOLIB_SX128X_PACKET_STATUS_SYNC_DET_3 \
    0b00000100  //  2     0                            detected sync word 3

// RADIOLIB_SX128X_CMD_SET_DIO_IRQ_PARAMS
#define RADIOLIB_SX128X_IRQ_PREAMBLE_DETECTED \
    0x8000  //  15    15  interrupt source: preamble detected
#define RADIOLIB_SX128X_IRQ_ADVANCED_RANGING_DONE \
    0x8000  //  15    15                    advanced ranging done
#define RADIOLIB_SX128X_IRQ_RX_TX_TIMEOUT 0x4000  //  14    14                    Rx or Tx timeout
#define RADIOLIB_SX128X_IRQ_CAD_DETECTED \
    0x2000  //  13    13                    channel activity detected
...
#define RADIOLIB_SX128X_IRQ_RANGING_MASTER_TIMEOUT \
    0x0400  //  10    10                    ranging timeout (master)
...
#define RADIOLIB_SX128X_IRQ_RX_DEFAULT \
    0x4062  //  15    0                     default for Rx (RX_DONE, RX_TX_TIMEOUT, CRC_ERROR and
            //  HEADER_ERROR)
...
/*!
  \class SX128x
  \brief Base class for %SX128x series. All derived classes for %SX128x (e.g. SX1280 or SX1281)
...
class SX128x : public PhysicalLayer
{
  public:
    ...
    */
    int16_t begin(float freq = 2400.0, float bw = 812.5, uint8_t sf = 9, uint8_t cr = 7,
                  uint8_t syncWord = RADIOLIB_SX128X_SYNC_WORD_PRIVATE, int8_t pwr = 10,
    ...
    /*!
      ...
      \returns \ref status_codes
    */
    int16_t beginGFSK(float freq = 2400.0, uint16_t br = 800, float freqDev = 400.0,
                      int8_t pwr = 10, uint16_t preambleLength = 16);
    ...
    /*!
      ...
      \param freqDev Frequency deviation from carrier frequency in kHz. Defaults to 400.0 kHz.
      \param pwr Output power in dBm. Defaults to 10 dBm.
      \param dataShaping Time-bandwidth product of the Gaussian filter to be used for shaping.
      Defaults to 0.5. \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      as %SX128x series does not support direct mode reception. Will always return
    ...
    */
    ...
    /*!
      ...
      RADIOLIB_SX128X_IRQ_RX_DONE. \param len Only for PhysicalLayer compatibility, not used.
      \returns \ref status_codes
    */
    int16_t startReceive(uint16_t timeout, uint16_t irqFlags = RADIOLIB_SX128X_IRQ_RX_DEFAULT,
                         uint16_t irqMask = RADIOLIB_SX128X_IRQ_RX_DONE, size_t len = 0);
    ...
    */
    ...
    /*!
      ...
      \param longInterleaving Whether to enable long interleaving mode. Not available for coding
      rate 4/7, defaults to false. \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      Allowed values are RADIOLIB_SHAPING_0_5 or RADIOLIB_SHAPING_1_0. Set to RADIOLIB_SHAPING_NONE
      to disable data shaping. \param sh Time-bandwidth product of Gaussian filter to be set.
      \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      \param polynomial Polynomial for CRC calculation. Defaults to 0x1021 (CCIT CRC), not available
      for LoRa or BLE modem. \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      or ranging modem. \returns SNR of the last received packet in dB.
    */
    float getSNR();
  ...
  protected:
    ...
    int16_t setRx(uint16_t periodBaseCount,
                  uint8_t periodBase = RADIOLIB_SX128X_PERIOD_BASE_15_625_US);
    int16_t setCad();
    ...
    int16_t setPacketParamsGFSK(uint8_t preambleLen, uint8_t syncLen, uint8_t syncMatch,
                                uint8_t crcLen, uint8_t whiten, uint8_t payLen = 0xFF,
                                uint8_t hdrType = RADIOLIB_SX128X_GFSK_FLRC_PACKET_VARIABLE);
