...
#define RADIOLIB_SX127X_ACCESS_SHARED_REG_OFF \
    0b00000000  //  6     6   access LoRa registers (0x0D:0x3F) in LoRa mode
#define RADIOLIB_SX127X_ACCESS_SHARED_REG_ON \
    0b01000000  //  6     6   access FSK registers (0x0D:0x3F) in LoRa mode
...
#define RADIOLIB_SX127X_PA_SELECT_RFO \
    0b00000000  //  7     7   RFO pin output, power limited to +14 dBm
#define RADIOLIB_SX127X_PA_SELECT_BOOST \
    0b10000000  //  7     7   PA_BOOST pin output, power limited to +20 dBm
#define RADIOLIB_SX127X_OUTPUT_POWER \
    0b00001111  //  3     0   output power: P_out = 2 + OUTPUT_POWER [dBm] for PA_SELECT_BOOST
...
#define RADIOLIB_SX127X_OCP_TRIM \
    0b00001011  //  4     0   OCP current: I_max(OCP_TRIM = 0b1011) = 100 mA
...
#define RADIOLIB_SX127X_PREAMBLE_LENGTH_MSB \
    0b00000000  //  7     0   2-byte preamble length setting: l_P = PREAMBLE_LENGTH + 4.25
#define RADIOLIB_SX127X_PREAMBLE_LENGTH_LSB \
    0b00001000  //  7     0       where l_p = preamble length

// RADIOLIB_SX127X_REG_DETECT_OPTIMIZE
#define RADIOLIB_SX127X_DETECT_OPTIMIZE_SF_6 0b00000101  //  2     0   SF6 detection optimization
#define RADIOLIB_SX127X_DETECT_OPTIMIZE_SF_7_12 \
    0b00000011  //  2     0   SF7 to SF12 detection optimization
...
#define RADIOLIB_SX127X_DETECTION_THRESHOLD_SF_7_12 \
    0b00001010  //  7     0   SF7 to SF12 detection threshold

// RADIOLIB_SX127X_REG_PA_DAC
#define RADIOLIB_SX127X_PA_BOOST_OFF 0b00000100  //  2     0   PA_BOOST disabled
#define RADIOLIB_SX127X_PA_BOOST_ON \
    0b00000111  //  2     0   +20 dBm on PA_BOOST when OUTPUT_POWER = 0b1111

// RADIOLIB_SX127X_REG_HOP_PERIOD
#define RADIOLIB_SX127X_HOP_PERIOD_OFF \
    0b00000000  //  7     0   number of periods between frequency hops; 0 = disabled
...
#define RADIOLIB_SX127X_CLEAR_IRQ_FLAG_TX_DONE \
    0b00001000  //  3     3   payload transmission complete
#define RADIOLIB_SX127X_CLEAR_IRQ_FLAG_CAD_DONE 0b00000100  //  2     2   CAD complete
#define RADIOLIB_SX127X_CLEAR_IRQ_FLAG_FHSS_CHANGE_CHANNEL \
    0b00000010  //  1     1   FHSS change channel
...
#define RADIOLIB_SX127X_MASK_IRQ_FLAG_TX_DONE \
    0b11110111  //  3     3   payload transmission complete
#define RADIOLIB_SX127X_MASK_IRQ_FLAG_CAD_DONE 0b11111011  //  2     2   CAD complete
#define RADIOLIB_SX127X_MASK_IRQ_FLAG_FHSS_CHANGE_CHANNEL \
    0b11111101  //  1     1   FHSS change channel
#define RADIOLIB_SX127X_MASK_IRQ_FLAG_CAD_DETECTED \
    0b11111110  //  0     0   valid LoRa signal detected during CAD operation
#define RADIOLIB_SX127X_MASK_IRQ_FLAG_RX_DEFAULT \
    0b00011111  //  7     0   default for Rx (RX_TIMEOUT, RX_DONE, CRC_ERR)

// RADIOLIB_SX127X_REG_FIFO_TX_BASE_ADDR
#define RADIOLIB_SX127X_FIFO_TX_BASE_ADDR_MAX \
    0b00000000  //  7     0   allocate the entire FIFO buffer for TX only

// RADIOLIB_SX127X_REG_FIFO_RX_BASE_ADDR
#define RADIOLIB_SX127X_FIFO_RX_BASE_ADDR_MAX \
    0b00000000  //  7     0   allocate the entire FIFO buffer for RX only

// RADIOLIB_SX127X_REG_SYNC_WORD
#define RADIOLIB_SX127X_SYNC_WORD 0x12  //  7     0   default LoRa sync word
#define RADIOLIB_SX127X_SYNC_WORD_LORAWAN \
    0x34  //  7     0   sync word reserved for LoRaWAN networks
...
#define RADIOLIB_SX127X_BITRATE_MSB \
    0x1A  //  7     0   bit rate setting: BitRate = F(XOSC)/(BITRATE + BITRATE_FRAC/16)
...
#define RADIOLIB_SX127X_RESTART_RX_ON_COLLISION_ON \
    0b10000000  //  7     7   automatically restart receiver if it gets saturated or on packet
                //  collision
...
#define RADIOLIB_SX127X_RX_TRIGGER_RSSI_INTERRUPT \
    0b00000001  //  2     0                        RSSI interrupt
#define RADIOLIB_SX127X_RX_TRIGGER_PREAMBLE_DETECT \
    0b00000110  //  2     0                        preamble detected
#define RADIOLIB_SX127X_RX_TRIGGER_BOTH \
    0b00000111  //  2     0                        RSSI interrupt and preamble detected

// RADIOLIB_SX127X_REG_RSSI_CONFIG
#define RADIOLIB_SX127X_RSSI_SMOOTHING_SAMPLES_2 \
    0b00000000  //  2     0   number of samples for RSSI average: 2
#define RADIOLIB_SX127X_RSSI_SMOOTHING_SAMPLES_4 \
    0b00000001  //  2     0                                       4
#define RADIOLIB_SX127X_RSSI_SMOOTHING_SAMPLES_8 \
    0b00000010  //  2     0                                       8 (default)
#define RADIOLIB_SX127X_RSSI_SMOOTHING_SAMPLES_16 \
    0b00000011  //  2     0                                       16
#define RADIOLIB_SX127X_RSSI_SMOOTHING_SAMPLES_32 \
    0b00000100  //  2     0                                       32
#define RADIOLIB_SX127X_RSSI_SMOOTHING_SAMPLES_64 \
    0b00000101  //  2     0                                       64
#define RADIOLIB_SX127X_RSSI_SMOOTHING_SAMPLES_128 \
    0b00000110  //  2     0                                       128
#define RADIOLIB_SX127X_RSSI_SMOOTHING_SAMPLES_256 \
    0b00000111  //  2     0                                       256

// RADIOLIB_SX127X_REG_RSSI_COLLISION
#define RADIOLIB_SX127X_RSSI_COLLISION_THRESHOLD \
    0x0A  //  7     0   RSSI threshold in dB that will be considered a collision, default value: 10
          //  dB

// RADIOLIB_SX127X_REG_RSSI_THRESH
#define RADIOLIB_SX127X_RSSI_THRESHOLD \
    0xFF  //  7     0   RSSI threshold that will trigger RSSI interrupt, RssiThreshold =
          //  RSSI_THRESHOLD / 2 [dBm]

// RADIOLIB_SX127X_REG_RX_BW
#define RADIOLIB_SX127X_RX_BW_MANT_16 \
    0b00000000  //  4     3   channel filter bandwidth: RxBw = F(XOSC) / (RxBwMant * 2^(RxBwExp +
                //  2)) [kHz]
...
#define RADIOLIB_SX127X_RX_BW_MANT_AFC \
    0b00001000  //  4     3   default RxBwMant parameter used during AFC
#define RADIOLIB_SX127X_RX_BW_EXP_AFC \
    0b00000011  //  2     0   default RxBwExp parameter used during AFC

// RADIOLIB_SX127X_REG_OOK_PEAK
#define RADIOLIB_SX127X_BIT_SYNC_OFF \
    0b00000000  //  5     5   bit synchronizer disabled (not allowed in packet mode)
...
#define RADIOLIB_SX127X_OOK_THRESH_PEAK \
    0b00001000  //  4     3                       peak mode (default)
#define RADIOLIB_SX127X_OOK_THRESH_AVERAGE \
    0b00010000  //  4     3                       average mode
#define RADIOLIB_SX127X_OOK_PEAK_THRESH_STEP_0_5_DB \
    0b00000000  //  2     0   OOK demodulator step size: 0.5 dB (default)
#define RADIOLIB_SX127X_OOK_PEAK_THRESH_STEP_1_0_DB \
    0b00000001  //  2     0                              1.0 dB
#define RADIOLIB_SX127X_OOK_PEAK_THRESH_STEP_1_5_DB \
    0b00000010  //  2     0                              1.5 dB
#define RADIOLIB_SX127X_OOK_PEAK_THRESH_STEP_2_0_DB \
    0b00000011  //  2     0                              2.0 dB
#define RADIOLIB_SX127X_OOK_PEAK_THRESH_STEP_3_0_DB \
    0b00000100  //  2     0                              3.0 dB
#define RADIOLIB_SX127X_OOK_PEAK_THRESH_STEP_4_0_DB \
    0b00000101  //  2     0                              4.0 dB
#define RADIOLIB_SX127X_OOK_PEAK_THRESH_STEP_5_0_DB \
    0b00000110  //  2     0                              5.0 dB
#define RADIOLIB_SX127X_OOK_PEAK_THRESH_STEP_6_0_DB \
    0b00000111  //  2     0                              6.0 dB

// RADIOLIB_SX127X_REG_OOK_FIX
#define RADIOLIB_SX127X_OOK_FIXED_THRESHOLD \
    0x0C  //  7     0   default fixed threshold for OOK data slicer
...
#define RADIOLIB_SX127X_OOK_AVERAGE_OFFSET_0_DB \
    0b00000000  //  3     2   OOK average threshold offset: 0.0 dB (default)
#define RADIOLIB_SX127X_OOK_AVERAGE_OFFSET_2_DB \
    0b00000100  //  3     2                                 2.0 dB
#define RADIOLIB_SX127X_OOK_AVERAGE_OFFSET_4_DB \
    0b00001000  //  3     2                                 4.0 dB
#define RADIOLIB_SX127X_OOK_AVERAGE_OFFSET_6_DB \
    0b00001100  //  3     2                                 6.0 dB
...
#define RADIOLIB_SX127X_OOK_AVG_THRESH_FILT_4_PI \
    0b00000010  //  1     0                                   chip rate / 4*pi (default)
...
#define RADIOLIB_SX127X_AFC_AUTO_CLEAR_OFF \
    0b00000000  //  0     0   AFC register will not be cleared at the start of AFC (default)
#define RADIOLIB_SX127X_AFC_AUTO_CLEAR_ON \
    0b00000001  //  0     0   AFC register will be cleared at the start of AFC
...
#define RADIOLIB_SX127X_PREAMBLE_DETECTOR_ON \
    0b10000000  //  7     7   preamble detection enabled (default)
#define RADIOLIB_SX127X_PREAMBLE_DETECTOR_1_BYTE \
    0b00000000  //  6     5   preamble detection size: 1 byte (default)
#define RADIOLIB_SX127X_PREAMBLE_DETECTOR_2_BYTE \
    0b00100000  //  6     5                            2 bytes
#define RADIOLIB_SX127X_PREAMBLE_DETECTOR_3_BYTE \
    0b01000000  //  6     5                            3 bytes
#define RADIOLIB_SX127X_PREAMBLE_DETECTOR_TOL \
    0x0A  //  4     0   default number of tolerated errors per chip (4 chips per bit)

// RADIOLIB_SX127X_REG_RX_TIMEOUT_1
#define RADIOLIB_SX127X_TIMEOUT_RX_RSSI_OFF \
    0x00  //  7     0   disable receiver timeout when RSSI interrupt doesn't occur (default)

// RADIOLIB_SX127X_REG_RX_TIMEOUT_2
#define RADIOLIB_SX127X_TIMEOUT_RX_PREAMBLE_OFF \
    0x00  //  7     0   disable receiver timeout when preamble interrupt doesn't occur (default)

// RADIOLIB_SX127X_REG_RX_TIMEOUT_3
#define RADIOLIB_SX127X_TIMEOUT_SIGNAL_SYNC_OFF \
    0x00  //  7     0   disable receiver timeout when sync address interrupt doesn't occur (default)

// RADIOLIB_SX127X_REG_OSC
#define RADIOLIB_SX127X_RC_CAL_START \
    0b00000000  //  3     3   manually start RC oscillator calibration
...
#define RADIOLIB_SX127X_AUTO_RESTART_RX_MODE_NO_PLL \
    0b01000000  //  7     6                                           enabled, don't wait for PLL
                //  lock
#define RADIOLIB_SX127X_AUTO_RESTART_RX_MODE_PLL \
    0b10000000  //  7     6                                           enabled, wait for PLL lock
                //  (default)
#define RADIOLIB_SX127X_PREAMBLE_POLARITY_AA \
    0b00000000  //  5     5   preamble polarity: 0xAA = 0b10101010 (default)
#define RADIOLIB_SX127X_PREAMBLE_POLARITY_55 \
    0b00100000                               //  5     5                      0x55 = 0b01010101
...
#define RADIOLIB_SX127X_SYNC_SIZE \
    0x03  //  2     0   sync word size in bytes, SyncSize = SYNC_SIZE + 1 bytes
...
#define RADIOLIB_SX127X_PACKET_VARIABLE \
    0b10000000  //  7     7                  variable length (default)
...
#define RADIOLIB_SX127X_CRC_AUTOCLEAR_OFF \
    0b00001000  //  3     3   keep FIFO on CRC mismatch, issue payload ready interrupt
#define RADIOLIB_SX127X_CRC_AUTOCLEAR_ON \
    0b00000000  //  3     3   clear FIFO on CRC mismatch, do not issue payload ready interrupt
#define RADIOLIB_SX127X_ADDRESS_FILTERING_OFF \
    0b00000000  //  2     1   address filtering: none (default)
#define RADIOLIB_SX127X_ADDRESS_FILTERING_NODE 0b00000010  //  2     1                      node
#define RADIOLIB_SX127X_ADDRESS_FILTERING_NODE_BROADCAST \
    0b00000100  //  2     1                      node or broadcast
#define RADIOLIB_SX127X_CRC_WHITENING_TYPE_CCITT \
    0b00000000  //  0     0   CRC and whitening algorithms: CCITT CRC with standard whitening
                //  (default)
#define RADIOLIB_SX127X_CRC_WHITENING_TYPE_IBM \
    0b00000001  //  0     0                                 IBM CRC with alternate whitening
...
#define RADIOLIB_SX127X_IO_HOME_OFF \
    0b00000000  //  5     5   io-homecontrol compatibility disabled (default)
#define RADIOLIB_SX127X_IO_HOME_ON 0b00100000  //  5     5   io-homecontrol compatibility enabled

// RADIOLIB_SX127X_REG_FIFO_THRESH
#define RADIOLIB_SX127X_TX_START_FIFO_LEVEL \
...
#define RADIOLIB_SX127X_TX_START_FIFO_NOT_EMPTY \
    0b10000000  //  7     7                                   at least one byte in FIFO (default)
...
#define RADIOLIB_SX127X_IDLE_MODE_STANDBY \
    0b00000000  //  5     5   chip mode during sequencer idle mode: standby (default)
#define RADIOLIB_SX127X_IDLE_MODE_SLEEP \
    0b00100000  //  5     5                                         sleep
#define RADIOLIB_SX127X_FROM_START_LP_SELECTION \
    0b00000000  //  4     3   mode that will be set after starting sequencer: low power selection
                //  (default)
#define RADIOLIB_SX127X_FROM_START_RECEIVE \
    0b00001000  //  4     3                                                   receive
#define RADIOLIB_SX127X_FROM_START_TRANSMIT \
    0b00010000  //  4     3                                                   transmit
#define RADIOLIB_SX127X_FROM_START_TRANSMIT_FIFO_LEVEL \
    0b00011000  //  4     3                                                   transmit on a FIFO
                //  level interrupt
#define RADIOLIB_SX127X_LP_SELECTION_SEQ_OFF \
    0b00000000  //  2     2   mode that will be set after exiting low power selection: sequencer off
                //  (default)
#define RADIOLIB_SX127X_LP_SELECTION_IDLE \
    0b00000100  //  2     2                                                            idle state
#define RADIOLIB_SX127X_FROM_IDLE_TRANSMIT \
    0b00000000  //  1     1   mode that will be set after exiting idle mode: transmit (default)
#define RADIOLIB_SX127X_FROM_IDLE_RECEIVE \
    0b00000010  //  1     1                                                  receive
#define RADIOLIB_SX127X_FROM_TRANSMIT_LP_SELECTION \
    0b00000000  //  0     0   mode that will be set after exiting transmit mode: low power selection
                //  (default)
#define RADIOLIB_SX127X_FROM_TRANSMIT_RECEIVE \
    0b00000001  //  0     0                                                      receive

// RADIOLIB_SX127X_REG_SEQ_CONFIG_2
#define RADIOLIB_SX127X_FROM_RECEIVE_PACKET_RECEIVED_PAYLOAD \
    0b00100000  //  7     5   mode that will be set after exiting receive mode: packet received on
                //  payload ready interrupt (default)
#define RADIOLIB_SX127X_FROM_RECEIVE_LP_SELECTION \
    0b01000000  //  7     5                                                     low power selection
#define RADIOLIB_SX127X_FROM_RECEIVE_PACKET_RECEIVED_CRC_OK \
    0b01100000  //  7     5                                                     packet received on
                //  CRC OK interrupt
#define RADIOLIB_SX127X_FROM_RECEIVE_SEQ_OFF_RSSI \
    0b10000000  //  7     5                                                     sequencer off on
                //  RSSI interrupt
#define RADIOLIB_SX127X_FROM_RECEIVE_SEQ_OFF_SYNC_ADDR \
    0b10100000  //  7     5                                                     sequencer off on
                //  sync address interrupt
#define RADIOLIB_SX127X_FROM_RECEIVE_SEQ_OFF_PREAMBLE_DETECT \
    0b11000000  //  7     5                                                     sequencer off on
                //  preamble detect interrupt
#define RADIOLIB_SX127X_FROM_RX_TIMEOUT_RECEIVE \
    0b00000000  //  4     3   mode that will be set after Rx timeout: receive (default)
...
#define RADIOLIB_SX127X_FROM_RX_TIMEOUT_LP_SELECTION \
    0b00010000  //  4     3                                           low power selection
...
#define RADIOLIB_SX127X_FROM_PACKET_RECEIVED_SEQ_OFF \
    0b00000000  //  2     0   mode that will be set after packet received: sequencer off (default)
...
#define RADIOLIB_SX127X_FROM_PACKET_RECEIVED_LP_SELECTION \
    0b00000010  //  2     0                                                low power selection
#define RADIOLIB_SX127X_FROM_PACKET_RECEIVED_RECEIVE_FS \
    0b00000011  //  2     0                                                receive via FS
...
#define RADIOLIB_SX127X_TIMER1_RESOLUTION_4_1_MS \
    0b00001000  //  3     2                       4.1 ms
#define RADIOLIB_SX127X_TIMER1_RESOLUTION_262_MS \
    0b00001100                                 //  3     2                       262 ms
...
#define RADIOLIB_SX127X_TIMER2_RESOLUTION_4_1_MS \
    0b00000010  //  3     2                       4.1 ms
#define RADIOLIB_SX127X_TIMER2_RESOLUTION_262_MS \
    0b00000011  //  3     2                       262 ms

// RADIOLIB_SX127X_REG_TIMER1_COEF
#define RADIOLIB_SX127X_TIMER1_COEFFICIENT \
    0xF5  //  7     0   multiplication coefficient for timer 1

// RADIOLIB_SX127X_REG_TIMER2_COEF
#define RADIOLIB_SX127X_TIMER2_COEFFICIENT \
    0x20  //  7     0   multiplication coefficient for timer 2

// RADIOLIB_SX127X_REG_IMAGE_CAL
#define RADIOLIB_SX127X_AUTO_IMAGE_CAL_OFF \
    0b00000000  //  7     7   temperature calibration disabled (default)
...
#define RADIOLIB_SX127X_IMAGE_CAL_RUNNING \
    0b00100000  //  5     5   temperature calibration is on-going
#define RADIOLIB_SX127X_IMAGE_CAL_COMPLETE \
    0b00000000  //  5     5   temperature calibration finished
#define RADIOLIB_SX127X_TEMP_CHANGED \
    0b00001000  //  3     3   temperature changed more than TEMP_THRESHOLD since last calibration
#define RADIOLIB_SX127X_TEMP_THRESHOLD_5_DEG_C \
    0b00000000  //  2     1   temperature change threshold: 5 deg. C
...
#define RADIOLIB_SX127X_TEMP_THRESHOLD_15_DEG_C \
    0b00000100  //  2     1                                 15 deg. C
#define RADIOLIB_SX127X_TEMP_THRESHOLD_20_DEG_C \
    0b00000110  //  2     1                                 20 deg. C
#define RADIOLIB_SX127X_TEMP_MONITOR_ON \
    0b00000000  //  0     0   temperature monitoring enabled (default)
...
#define RADIOLIB_SX127X_LOW_BAT_TRIM_1_695_V \
    0b00000000  //  2     0   battery voltage threshold: 1.695 V
#define RADIOLIB_SX127X_LOW_BAT_TRIM_1_764_V \
    0b00000001  //  2     0                              1.764 V
#define RADIOLIB_SX127X_LOW_BAT_TRIM_1_835_V \
    0b00000010  //  2     0                              1.835 V (default)
#define RADIOLIB_SX127X_LOW_BAT_TRIM_1_905_V \
    0b00000011  //  2     0                              1.905 V
#define RADIOLIB_SX127X_LOW_BAT_TRIM_1_976_V \
    0b00000100  //  2     0                              1.976 V
#define RADIOLIB_SX127X_LOW_BAT_TRIM_2_045_V \
    0b00000101  //  2     0                              2.045 V
#define RADIOLIB_SX127X_LOW_BAT_TRIM_2_116_V \
    0b00000110  //  2     0                              2.116 V
#define RADIOLIB_SX127X_LOW_BAT_TRIM_2_185_V \
    0b00000111  //  2     0                              2.185 V

// RADIOLIB_SX127X_REG_IRQ_FLAGS_1
#define RADIOLIB_SX127X_FLAG_MODE_READY 0b10000000  //  7     7   requested mode is ready
#define RADIOLIB_SX127X_FLAG_RX_READY \
    0b01000000  //  6     6   reception ready (after RSSI, AGC, AFC)
#define RADIOLIB_SX127X_FLAG_TX_READY \
    0b00100000  //  5     5   transmission ready (after PA ramp-up)
...
#define RADIOLIB_SX127X_FLAG_FIFO_LEVEL \
    0b00100000  //  5     5   number of bytes in FIFO exceeds FIFO_THRESHOLD
...
#define RADIOLIB_SX127X_FLAG_PAYLOAD_READY \
    0b00000100                                  //  2     2   packet was successfully received
#define RADIOLIB_SX127X_FLAG_CRC_OK 0b00000010  //  1     1   CRC check passed
#define RADIOLIB_SX127X_FLAG_LOW_BAT \
    0b00000001  //  0     0   battery voltage dropped below threshold
...
#define RADIOLIB_SX127X_FAST_HOP_OFF \
    0b00000000  //  7     7   carrier frequency validated when FRF registers are written
#define RADIOLIB_SX127X_FAST_HOP_ON \
    0b10000000  //  7     7   carrier frequency validated when FS modes are requested

// SX1272_REG_TCXO + SX1278_REG_TCXO
#define RADIOLIB_SX127X_TCXO_INPUT_EXTERNAL \
    0b00000000  //  4     4   use external crystal oscillator
#define RADIOLIB_SX127X_TCXO_INPUT_EXTERNAL_CLIPPED \
    0b00010000  //  4     4   use external crystal oscillator clipped sine connected to XTA pin
...
#define RADIOLIB_SX127X_PLL_BANDWIDTH_300_KHZ \
    0b11000000  //  7     6                  300 kHz (default)

/*!
  \class SX127x
  \brief Base class for SX127x series. All derived classes for SX127x (e.g. SX1278 or SX1272)
  inherit from this base class. This class should not be instantiated directly from Arduino sketch,
  only from its derived classes.
*/
class SX127x : public PhysicalLayer
{
  public:
    ...
    */
    ...
    /*!
      \brief Initialization method. Will be called with appropriate parameters when calling
      initialization method from derived class. \param chipVersion Array of possible values in SPI
      version register. Used to verify the connection and hardware version. \param numVersions
      Number of possible chip versions. \param syncWord %LoRa sync word. \param preambleLength
      Length of %LoRa transmission preamble in symbols. \returns \ref status_codes
    */
    int16_t begin(uint8_t* chipVersions, uint8_t numVersions, uint8_t syncWord,
                  uint16_t preambleLength);

    /*!
      \brief Reset method. Will reset the chip to the default state using RST pin. Declared pure
      virtual since SX1272 and SX1278 implementations differ.
    */
    virtual void reset() = 0;

    /*!
      \brief Initialization method for FSK modem. Will be called with appropriate parameters when
      calling FSK initialization method from derived class. \param chipVersion Array of possible
      values in SPI version register. Used to verify the connection and hardware version. \param
      numVersions Number of possible chip versions. \param freqDev Frequency deviation of the FSK
      transmission in kHz. \param rxBw Receiver bandwidth in kHz. \param preambleLength Length of
      FSK preamble in bits. \param enableOOK Flag to specify OOK mode. This modulation is similar to
      FSK. \returns \ref status_codes
    */
    int16_t beginFSK(uint8_t* chipVersions, uint8_t numVersions, float freqDev, float rxBw,
                     uint16_t preambleLength, bool enableOOK);

    /*!
      \brief Binary transmit method. Will transmit arbitrary binary data up to 255 bytes long using
      %LoRa or up to 63 bytes using FSK modem. For overloads to transmit Arduino String or C-string,
      see PhysicalLayer::transmit. \param data Binary data that will be transmitted. \param len
      Length of binary data to transmit (in bytes). \param addr Node address to transmit the packet
      to. Only used in FSK mode. \returns \ref status_codes
    */
    int16_t transmit(uint8_t* data, size_t len, uint8_t addr = 0) override;

    /*!
      \brief Binary receive method. Will attempt to receive arbitrary binary data up to 255 bytes
      long using %LoRa or up to 63 bytes using FSK modem. For overloads to receive Arduino String,
      see PhysicalLayer::receive. \param data Pointer to array to save the received binary data.
      \param len Number of bytes that will be received. Must be known in advance for binary
      transmissions. \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      \brief Sets the %LoRa module to sleep to save power. %Module will not be able to transmit or
      receive any data while in sleep mode. %Module will wake up automatically when methods like
      transmit or receive are called. \returns \ref status_codes
    */
    int16_t sleep();
    ...
    */
    ...
    /*!
      \brief Sets the %LoRa module to standby.
      \param mode Standby mode to be used. No effect, implemented only for PhysicalLayer
    ...
    */
    ...
    /*!
      ...
      While in direct mode, the module will not be able to transmit or receive packets. Can only be
      activated in FSK mode. \param frf 24-bit raw frequency value to start transmitting at.
      Required for quick frequency shifts in RTTY. \returns \ref status_codes
    */
    ...
    /*!
      ...
      While in direct mode, the module will not be able to transmit or receive packets. Can only be
      activated in FSK mode. \returns \ref status_codes
    */
    int16_t receiveDirect() override;

    /*!
      \brief Disables direct mode and enables packet mode, allowing the module to receive packets.
      Can only be activated in FSK mode. \returns \ref status_codes
    */
    int16_t packetMode();
    ...
    */
    ...
    /*!
      ...
      \param remLen Pointer to a counter holding the number of bytes that have been transmitted so
      far. \returns True when a complete packet is sent, false if more data is needed.
    */
    ...
    */
    ...
    /*!
      \brief Interrupt-driven binary transmit method. Will start transmitting arbitrary binary data
      up to 255 bytes long using %LoRa or up to 63 bytes using FSK modem. \param data Binary data
      that will be transmitted. \param len Length of binary data to transmit (in bytes). \param addr
      Node address to transmit the packet to. Only used in FSK mode. \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      \brief Interrupt-driven receive method. DIO0 will be activated when full valid packet is
      received. \param len Expected length of packet to be received, or 0 when unused. Defaults to
      0, non-zero required for LoRa spreading factor 6. \param mode Receive mode to be used.
      Defaults to RxContinuous. \returns \ref status_codes
    */
    ...
    /*!
      ...
      When non-zero (maximum 1023), the device will be set to Rx single mode and timeout will be
      set. \param irqFlags Ignored. \param irqMask Ignored. \param len Expected length of packet to
      be received. Required for LoRa spreading factor 6. \returns \ref status_codes
    */
    int16_t startReceive(uint32_t timeout, uint16_t irqFlags, uint16_t irqMask, size_t len);

    /*!
      \brief Reads data that was received after calling startReceive method. When the packet length
      is not known in advance, getPacketLength method must be called BEFORE calling readData! \param
      data Pointer to array to save the received binary data. \param len Number of bytes that will
      be read. When set to 0, the packet length will be retrieved automatically. When more bytes
      than received are requested, only the number of bytes requested will be returned. \returns
      \ref status_codes
    */
    int16_t readData(uint8_t* data, size_t len) override;

    /*!
      \brief Interrupt-driven channel activity detection method. DIO0 will be activated when LoRa
      preamble is detected. DIO1 will be activated if there's no preamble detected before timeout.
      \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      \brief Sets current limit for over current protection at transmitter amplifier. Allowed values
      range from 45 to 120 mA in 5 mA steps and 120 to 240 mA in 10 mA steps. \param currentLimit
      Current limit to be set (in mA). \returns \ref status_codes
    */
    int16_t setCurrentLimit(uint8_t currentLimit);

    /*!
      \brief Sets %LoRa or FSK preamble length. Allowed values range from 6 to 65535 in %LoRa mode
      or 0 to 65535 in FSK mode. \param preambleLength Preamble length to be set (in symbols when in
      LoRa mode or bits in FSK mode). \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      \brief Sets FSK frequency deviation from carrier frequency. Allowed values depend on bit rate
      setting and must be lower than 200 kHz. Only available in FSK mode. \param freqDev Frequency
      deviation to be set (in kHz). \returns \ref status_codes
    */
    int16_t setFrequencyDeviation(float freqDev) override;

    /*!
      \brief Sets FSK receiver bandwidth. Allowed values range from 2.6 to 250 kHz. Only available
      in FSK mode. \param rxBw Receiver bandwidth to be set (in kHz). \returns \ref status_codes
    */
    int16_t setRxBandwidth(float rxBw);

    /*!
      \brief Sets FSK automatic frequency correction bandwidth. Allowed values range from 2.6 to 250
      kHz. Only available in FSK mode. \param rxBw Receiver AFC bandwidth to be set (in kHz).
      \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      \param trigger one from SX127X_RX_TRIGGER_NONE, SX127X_RX_TRIGGER_RSSI_INTERRUPT,
      SX127X_RX_TRIGGER_PREAMBLE_DETECT, SX127X_RX_TRIGGER_BOTH \return \ref status_codes
    */
    int16_t setAFCAGCTrigger(uint8_t trigger);

    /*!
      \brief Sets FSK sync word. Allowed sync words are up to 8 bytes long and can not contain null
      bytes. Only available in FSK mode. \param syncWord Sync word array. \param len Sync word
      length (in bytes). \returns \ref status_codes
    */
    int16_t setSyncWord(uint8_t* syncWord, size_t len) override;

    /*!
      \brief Sets FSK node address. Calling this method will enable address filtering. Only
      available in FSK mode. \param nodeAddr Node address to be set. \returns \ref status_codes
    */
    int16_t setNodeAddress(uint8_t nodeAddr);

    /*!
      \brief Sets FSK broadcast address. Calling this method will enable address filtering. Only
      available in FSK mode. \param broadAddr Broadcast address to be set. \returns \ref
      status_codes
    */
    ...
    */
    ...
    /*!
      ...
      \param type Threshold type: SX127X_OOK_THRESH_PEAK(default), SX127X_OOK_THRESH_FIXED,
      SX127X_OOK_THRESH_AVERAGE \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      in OOK when Peak mode is used. \param value Threshold level in steps of 0.5 dB. \returns \ref
      status_codes
    */
    ...
    /*!
      ...
      \param value Step size: RADIOLIB_SX127X_OOK_PEAK_THRESH_STEP_0_5_DB (default),
    ...
    */
    ...
    /*!
      \brief Calculate the timeout value for this specific module / series (in number of symbols or
      units of time) \param timeoutUs Timeout in microseconds to listen for \returns Timeout value
      in a unit that is specific for the used module
    */
    ...
    */
    ...
    /*!
      ...
      numSamples = 2 ^ (1 + smoothingSamples), allowed values are in range 0 (2 samples) - 7 (256
      samples) \param offset Signed RSSI offset that will be automatically compensated. 1 dB per
      LSB, defaults to 0, allowed values are in range -16 dB to +15 dB. \returns \ref status_codes
    */
    ...
    /*!
      ...
      RADIOLIB_ENCODING_WHITENING. \param encoding Encoding to be used. \returns \ref status_codes
    */
    ...
    /*!
      ...
      In FSK mode, this is the contents of SX127X_REG_IRQ_FLAGS_2 (MSB) and SX127X_REG_IRQ_FLAGS_1
      (LSB) registers. \returns IRQ flags.
    */
    ...
    */
    ...
    /*!
      \brief Read version SPI register. Should return SX1278_CHIP_VERSION (0x12) or
      SX1272_CHIP_VERSION (0x22) if SX127x is connected and working. \returns Version register
      contents or \ref status_codes
    */
    ...
    */
    ...
    /*!
      \brief Set interrupt service routine function to call when data bit is received in direct
      mode. \param func Pointer to interrupt service routine.
    */
    ...
    */
    ...
    /*!
      ...
      \param value The value that indicates which function to place on that pin. See chip datasheet
      for details. \returns \ref status_codes
    */
    int16_t setDIOMapping(uint32_t pin, uint32_t value);

    /*!
      \brief Configure DIO mapping to use RSSI or Preamble Detect for pins that support it.
      \param usePreambleDetect Whether to use PreambleDetect (true) or RSSI (false) on the pins that
      are mapped to this function. \returns \ref status_codes
    */
    int16_t setDIOPreambleDetect(bool usePreambleDetect);

    /*!
      \brief Gets recorded signal strength indicator.
      \param packet Whether to read last packet RSSI, or the current value. LoRa mode only, ignored
      for FSK. \param skipReceive Set to true to skip putting radio in receive mode for the RSSI
      measurement in FSK/OOK mode. \returns RSSI value in dBm.
    */
  ...
  private:
    ...
    bool packetLengthQueried =
        false;  // FSK packet length is the first byte in FIFO, length can only be queried once
    ...
    void clearIRQFlags();
    void clearFIFO(
        size_t count);  // used mostly to clear remaining bytes in FIFO after a packet read
