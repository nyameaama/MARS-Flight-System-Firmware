...
#define RADIOLIB_CC1101_STATUS_CHIP_NOT_READY \
    0b10000000  //  7     7   chip not ready (power/crystal not stable)
...
#define RADIOLIB_CC1101_GDO_DS_LOW \
    0b00000000  //  7     7   GDOx output drive strength: low (default)
...
#define RADIOLIB_CC1101_GDO0_TEMP_SENSOR_ON \
...
#define RADIOLIB_CC1101_GDOX_SYNC_WORD_SENT_OR_PKT_RECEIVED \
    0x06  //  5     0   sync word was sent or packet was received
#define RADIOLIB_CC1101_GDOX_PKT_RECEIVED_CRC_OK \
    0x07  //  5     0   packet received and CRC check passed
#define RADIOLIB_CC1101_GDOX_PREAMBLE_QUALITY_REACHED \
    0x08  //  5     0   received preamble quality is above threshold
#define RADIOLIB_CC1101_GDOX_CHANNEL_CLEAR \
    0x09  //  5     0   RSSI level below threshold (channel is clear)
...
#define RADIOLIB_CC1101_GDOX_SERIAL_DATA_SYNC \
    0x0C  //  5     0   serial data output in: synchronous mode
#define RADIOLIB_CC1101_GDOX_SERIAL_DATA_ASYNC \
    0x0D  //  5     0                          asynchronous mode
...
#define RADIOLIB_CC1101_GDOX_RX_SYMBOL_TICK \
    0x1D  //  5     0   direct access to symbol tick of received data
...
#define RADIOLIB_CC1101_GDOX_CLOCK_XOSC_1 \
    0x30  //  5     0   crystal oscillator clock: f = f(XOSC)/1
#define RADIOLIB_CC1101_GDOX_CLOCK_XOSC_1_5 \
    0x31  //  5     0                             f = f(XOSC)/1.5
#define RADIOLIB_CC1101_GDOX_CLOCK_XOSC_2 \
    0x32  //  5     0                             f = f(XOSC)/2
#define RADIOLIB_CC1101_GDOX_CLOCK_XOSC_3 \
    0x33  //  5     0                             f = f(XOSC)/3
#define RADIOLIB_CC1101_GDOX_CLOCK_XOSC_4 \
    0x34  //  5     0                             f = f(XOSC)/4
#define RADIOLIB_CC1101_GDOX_CLOCK_XOSC_6 \
    0x35  //  5     0                             f = f(XOSC)/6
#define RADIOLIB_CC1101_GDOX_CLOCK_XOSC_8 \
    0x36  //  5     0                             f = f(XOSC)/8
#define RADIOLIB_CC1101_GDOX_CLOCK_XOSC_12 \
    0x37  //  5     0                             f = f(XOSC)/12
#define RADIOLIB_CC1101_GDOX_CLOCK_XOSC_16 \
    0x38  //  5     0                             f = f(XOSC)/16
#define RADIOLIB_CC1101_GDOX_CLOCK_XOSC_24 \
    0x39  //  5     0                             f = f(XOSC)/24
#define RADIOLIB_CC1101_GDOX_CLOCK_XOSC_32 \
    0x3A  //  5     0                             f = f(XOSC)/32
#define RADIOLIB_CC1101_GDOX_CLOCK_XOSC_48 \
    0x3B  //  5     0                             f = f(XOSC)/48
#define RADIOLIB_CC1101_GDOX_CLOCK_XOSC_64 \
    0x3C  //  5     0                             f = f(XOSC)/64
#define RADIOLIB_CC1101_GDOX_CLOCK_XOSC_96 \
    0x3D  //  5     0                             f = f(XOSC)/96
#define RADIOLIB_CC1101_GDOX_CLOCK_XOSC_128 \
    0x3E  //  5     0                             f = f(XOSC)/128
#define RADIOLIB_CC1101_GDOX_CLOCK_XOSC_192 \
    0x3F  //  5     0                             f = f(XOSC)/192 (default for GDO0)

// RADIOLIB_CC1101_REG_FIFOTHR
#define RADIOLIB_CC1101_ADC_RETENTION_OFF \
    0b00000000  //  6     6   do not retain ADC settings in sleep mode (default)
...
#define RADIOLIB_CC1101_FIFO_THR_TX_61_RX_4 \
    0b00000000  //  3     0   TX fifo threshold: 61, RX fifo threshold: 4
#define RADIOLIB_CC1101_FIFO_THR_TX_33_RX_32 \
    0b00000111  //  3     0   TX fifo threshold: 33, RX fifo threshold: 32
...
#define RADIOLIB_CC1101_CRC_AUTOFLUSH_OFF \
    0b00000000  //  3     3   automatic Rx FIFO flush on CRC check fail: disabled (default)
#define RADIOLIB_CC1101_CRC_AUTOFLUSH_ON \
    0b00001000  //  3     3                                              enabled
#define RADIOLIB_CC1101_APPEND_STATUS_OFF \
    0b00000000  //  2     2   append 2 status bytes to packet: disabled
#define RADIOLIB_CC1101_APPEND_STATUS_ON \
...
#define RADIOLIB_CC1101_ADR_CHK_NO_BROADCAST \
    0b00000001  //  1     0                  without broadcast
#define RADIOLIB_CC1101_ADR_CHK_SINGLE_BROADCAST \
    0b00000010  //  1     0                  broadcast address 0x00
...
#define RADIOLIB_CC1101_PKT_FORMAT_SYNCHRONOUS \
    0b00010000  //  5     4                  synchronous serial
#define RADIOLIB_CC1101_PKT_FORMAT_RANDOM \
    0b00100000  //  5     4                  random transmissions
#define RADIOLIB_CC1101_PKT_FORMAT_ASYNCHRONOUS \
    0b00110000                              //  5     4                  asynchronous serial
...
#define RADIOLIB_CC1101_LENGTH_CONFIG_VARIABLE \
    0b00000001  //  1     0                  variable (default)
...
#define RADIOLIB_CC1101_FREQ_IF \
    0x0F  //  4     0   IF frequency setting; f_IF = (f(XOSC) / 2^10) * CC1101_FREQ_IF

// CC1101_REG_FSCTRL0
#define RADIOLIB_CC1101_FREQOFF 0x00  //  7     0   base frequency offset (2s-compliment)

// RADIOLIB_CC1101_REG_FREQ2 + REG_FREQ1 + REG_FREQ0
#define RADIOLIB_CC1101_FREQ_MSB \
    0x1E  //  5     0   base frequency setting: f_carrier = (f(XOSC) / 2^16) * FREQ
...
#define RADIOLIB_CC1101_CHANBW_E \
    0b10000000  //  7     6   channel bandwidth: BW_channel = f(XOSC) / (8 * (4 +
                //  CHANBW_M)*2^CHANBW_E) [Hz]
#define RADIOLIB_CC1101_CHANBW_M \
    0b00000000  //  5     4       default value for 26 MHz crystal: 203 125 Hz
#define RADIOLIB_CC1101_DRATE_E \
    0x0C  //  3     0   symbol rate: R_data = (((256 + DRATE_M) * 2^DRATE_E) / 2^28) * f(XOSC)
          //  [Baud]
...
#define RADIOLIB_CC1101_DEM_DCFILT_ON \
    0b00000000  //  7     7                      enabled - only for data rates above 250 kBaud
                //  (default)
#define RADIOLIB_CC1101_MOD_FORMAT_2_FSK \
    0b00000000                                      //  6     4   modulation format: 2-FSK (default)
...
#define RADIOLIB_CC1101_MOD_FORMAT_MFSK \
    0b01110000  //  6     4                      MFSK - only for data rates above 26 kBaud
#define RADIOLIB_CC1101_MANCHESTER_EN_OFF \
    0b00000000  //  3     3   Manchester encoding: disabled (default)
...
#define RADIOLIB_CC1101_SYNC_MODE_15_16 \
    0b00000001  //  2     0                    15/16 sync word bits
#define RADIOLIB_CC1101_SYNC_MODE_16_16 \
    0b00000010  //  2     0                    16/16 sync word bits (default)
#define RADIOLIB_CC1101_SYNC_MODE_30_32 \
    0b00000011  //  2     0                    30/32 sync word bits
#define RADIOLIB_CC1101_SYNC_MODE_NONE_THR \
    0b00000100  //  2     0                    no preamble sync, carrier sense above threshold
#define RADIOLIB_CC1101_SYNC_MODE_15_16_THR \
    0b00000101  //  2     0                    15/16 sync word bits, carrier sense above threshold
#define RADIOLIB_CC1101_SYNC_MODE_16_16_THR \
    0b00000110  //  2     0                    16/16 sync word bits, carrier sense above threshold
#define RADIOLIB_CC1101_SYNC_MODE_30_32_THR \
    0b00000111  //  2     0                    30/32 sync word bits, carrier sense above threshold

// RADIOLIB_CC1101_REG_MDMCFG1
#define RADIOLIB_CC1101_FEC_OFF \
    0b00000000  //  7     7   forward error correction: disabled (default)
#define RADIOLIB_CC1101_FEC_ON \
    0b10000000  //  7     7                             enabled - only for fixed packet length
...
#define RADIOLIB_CC1101_NUM_PREAMBLE_4 \
    0b00100000  //  6     4                             4 (default)
...
#define RADIOLIB_CC1101_CHANSPC_E \
    0x02  //  1     0   channel spacing: df_channel = (f(XOSC) / 2^18) * (256 + CHANSPC_M) *
          //  2^CHANSPC_E [Hz]
...
#define RADIOLIB_CC1101_DEVIATION_E \
    0b01000000  //  6     4   frequency deviation: f_dev = (f(XOSC) / 2^17) * (8 + DEVIATION_M) *
                //  2^DEVIATION_E [Hz]
#define RADIOLIB_CC1101_DEVIATION_M \
    0b00000111  //  2     0       default value for 26 MHz crystal: +- 47 607 Hz
#define RADIOLIB_CC1101_MSK_PHASE_CHANGE_PERIOD \
    0x07  //  2     0   phase change symbol period fraction: 1 / (MSK_PHASE_CHANGE_PERIOD + 1)

// RADIOLIB_CC1101_REG_MCSM2
#define RADIOLIB_CC1101_RX_TIMEOUT_RSSI_OFF \
    0b00000000  //  4     4   Rx timeout based on RSSI value: disabled (default)
#define RADIOLIB_CC1101_RX_TIMEOUT_RSSI_ON \
    0b00010000  //  4     4                                   enabled
#define RADIOLIB_CC1101_RX_TIMEOUT_QUAL_OFF \
    0b00000000  //  3     3   check for sync word on Rx timeout
...
#define RADIOLIB_CC1101_RX_TIMEOUT_MAX \
    0b00000000  //  2     0               max value (actual value depends on WOR_RES, EVENT0 and
                //  f(XOSC))

// RADIOLIB_CC1101_REG_MCSM1
#define RADIOLIB_CC1101_CCA_MODE_ALWAYS 0b00000000  //  5     4   clear channel indication: always
#define RADIOLIB_CC1101_CCA_MODE_RSSI_THR \
    0b00010000  //  5     4                             RSSI below threshold
#define RADIOLIB_CC1101_CCA_MODE_RX_PKT \
    0b00100000  //  5     4                             unless receiving packet
#define RADIOLIB_CC1101_CCA_MODE_RSSI_THR_RX_PKT \
    0b00110000  //  5     4                             RSSI below threshold unless receiving packet
                //  (default)
#define RADIOLIB_CC1101_RXOFF_IDLE \
    0b00000000  //  3     2   next mode after packet reception: idle (default)
#define RADIOLIB_CC1101_RXOFF_FSTXON \
    0b00000100                               //  3     2                                     FSTxOn
#define RADIOLIB_CC1101_RXOFF_TX 0b00001000  //  3     2                                     Tx
#define RADIOLIB_CC1101_RXOFF_RX 0b00001100  //  3     2                                     Rx
#define RADIOLIB_CC1101_TXOFF_IDLE \
    0b00000000  //  1     0   next mode after packet transmission: idle (default)
#define RADIOLIB_CC1101_TXOFF_FSTXON \
    0b00000001  //  1     0                                        FSTxOn
...
#define RADIOLIB_CC1101_FS_AUTOCAL_NEVER \
    0b00000000  //  5     4   automatic calibration: never (default)
#define RADIOLIB_CC1101_FS_AUTOCAL_IDLE_TO_RXTX \
    0b00010000  //  5     4                          every transition from idle to Rx/Tx
#define RADIOLIB_CC1101_FS_AUTOCAL_RXTX_TO_IDLE \
    0b00100000  //  5     4                          every transition from Rx/Tx to idle
#define RADIOLIB_CC1101_FS_AUTOCAL_RXTX_TO_IDLE_4TH \
    0b00110000  //  5     4                          every 4th transition from Rx/Tx to idle
#define RADIOLIB_CC1101_PO_TIMEOUT_COUNT_1 \
    0b00000000  //  3     2   number of counter expirations before CHP_RDYN goes low: 1 (default)
#define RADIOLIB_CC1101_PO_TIMEOUT_COUNT_16 \
    0b00000100  //  3     2                                                           16
#define RADIOLIB_CC1101_PO_TIMEOUT_COUNT_64 \
    0b00001000  //  3     2                                                           64
#define RADIOLIB_CC1101_PO_TIMEOUT_COUNT_256 \
    0b00001100  //  3     2                                                           256
...
#define RADIOLIB_CC1101_XOSC_FORCE_OFF \
    0b00000000  //  0     0   do not force XOSC to remain on in sleep (default)
#define RADIOLIB_CC1101_XOSC_FORCE_ON 0b00000001  //  0     0   force XOSC to remain on in sleep

// RADIOLIB_CC1101_REG_FOCCFG
#define RADIOLIB_CC1101_FOC_BS_CS_GATE_OFF \
    0b00000000  //  5     5   do not freeze frequency compensation until CS goes high
#define RADIOLIB_CC1101_FOC_BS_CS_GATE_ON \
    0b00100000  //  5     5   freeze frequency compensation until CS goes high (default)
#define RADIOLIB_CC1101_FOC_PRE_K \
    0b00000000  //  4     3   frequency compensation loop gain before sync word: K
#define RADIOLIB_CC1101_FOC_PRE_2K \
    0b00001000  //  4     3                                                      2K
#define RADIOLIB_CC1101_FOC_PRE_3K \
    0b00010000  //  4     3                                                      3K (default)
#define RADIOLIB_CC1101_FOC_PRE_4K \
    0b00011000  //  4     3                                                      4K
#define RADIOLIB_CC1101_FOC_POST_K \
    0b00000000  //  2     2   frequency compensation loop gain after sync word: same as FOC_PRE
#define RADIOLIB_CC1101_FOC_POST_K_2 \
    0b00000100  //  2     2                                                     K/2 (default)
#define RADIOLIB_CC1101_FOC_LIMIT_NO_COMPENSATION \
    0b00000000  //  1     0   frequency compensation saturation point: no compensation - required
                //  for ASK/OOK
#define RADIOLIB_CC1101_FOC_LIMIT_BW_CHAN_8 \
    0b00000001  //  1     0                                            +- BW_chan/8
#define RADIOLIB_CC1101_FOC_LIMIT_BW_CHAN_4 \
    0b00000010  //  1     0                                            +- BW_chan/4 (default)
...
#define RADIOLIB_CC1101_BS_PRE_KI \
    0b00000000  //  7     6   clock recovery integral gain before sync word: Ki
#define RADIOLIB_CC1101_BS_PRE_2KI \
    0b01000000  //  7     6                                                  2Ki (default)
#define RADIOLIB_CC1101_BS_PRE_3KI \
    0b10000000  //  7     6                                                  3Ki
#define RADIOLIB_CC1101_BS_PRE_4KI \
    0b11000000  //  7     6                                                  4Ki
#define RADIOLIB_CC1101_BS_PRE_KP \
    0b00000000  //  5     4   clock recovery proportional gain before sync word: Kp
#define RADIOLIB_CC1101_BS_PRE_2KP \
    0b00010000  //  5     4                                                      2Kp
#define RADIOLIB_CC1101_BS_PRE_3KP \
    0b00100000  //  5     4                                                      3Kp (default)
#define RADIOLIB_CC1101_BS_PRE_4KP \
    0b00110000  //  5     4                                                      4Kp
#define RADIOLIB_CC1101_BS_POST_KI \
    0b00000000  //  3     3   clock recovery integral gain after sync word: same as BS_PRE
#define RADIOLIB_CC1101_BS_POST_KI_2 \
    0b00001000  //  3     3                                                 Ki/2 (default)
#define RADIOLIB_CC1101_BS_POST_KP \
    0b00000000  //  2     2   clock recovery proportional gain after sync word: same as BS_PRE
#define RADIOLIB_CC1101_BS_POST_KP_1 \
    0b00000100  //  2     2                                                     Kp (default)
#define RADIOLIB_CC1101_BS_LIMIT_NO_COMPENSATION \
    0b00000000  //  1     0   data rate compensation saturation point: no compensation
#define RADIOLIB_CC1101_BS_LIMIT_3_125 \
    0b00000001  //  1     0                                            +- 3.125 %
#define RADIOLIB_CC1101_BS_LIMIT_6_25 \
    0b00000010  //  1     0                                            +- 6.25 %
#define RADIOLIB_CC1101_BS_LIMIT_12_5 \
    0b00000011  //  1     0                                            +- 12.5 %

// RADIOLIB_CC1101_REG_AGCCTRL2
#define RADIOLIB_CC1101_MAX_DVGA_GAIN_0 \
    0b00000000  //  7     6   reduce maximum available DVGA gain: no reduction (default)
#define RADIOLIB_CC1101_MAX_DVGA_GAIN_1 \
    0b01000000  //  7     6                                       disable top gain setting
#define RADIOLIB_CC1101_MAX_DVGA_GAIN_2 \
    0b10000000  //  7     6                                       disable top two gain setting
#define RADIOLIB_CC1101_MAX_DVGA_GAIN_3 \
    0b11000000  //  7     6                                       disable top three gain setting
#define RADIOLIB_CC1101_LNA_GAIN_REDUCE_0_DB \
    0b00000000  //  5     3   reduce maximum LNA gain by: 0 dB (default)
#define RADIOLIB_CC1101_LNA_GAIN_REDUCE_2_6_DB \
    0b00001000  //  5     3                               2.6 dB
#define RADIOLIB_CC1101_LNA_GAIN_REDUCE_6_1_DB \
    0b00010000  //  5     3                               6.1 dB
#define RADIOLIB_CC1101_LNA_GAIN_REDUCE_7_4_DB \
    0b00011000  //  5     3                               7.4 dB
#define RADIOLIB_CC1101_LNA_GAIN_REDUCE_9_2_DB \
    0b00100000  //  5     3                               9.2 dB
#define RADIOLIB_CC1101_LNA_GAIN_REDUCE_11_5_DB \
    0b00101000  //  5     3                               11.5 dB
#define RADIOLIB_CC1101_LNA_GAIN_REDUCE_14_6_DB \
    0b00110000  //  5     3                               14.6 dB
#define RADIOLIB_CC1101_LNA_GAIN_REDUCE_17_1_DB \
    0b00111000  //  5     3                               17.1 dB
#define RADIOLIB_CC1101_MAGN_TARGET_24_DB \
    0b00000000  //  2     0   average amplitude target for filter: 24 dB
#define RADIOLIB_CC1101_MAGN_TARGET_27_DB \
    0b00000001  //  2     0                                        27 dB
#define RADIOLIB_CC1101_MAGN_TARGET_30_DB \
    0b00000010  //  2     0                                        30 dB
#define RADIOLIB_CC1101_MAGN_TARGET_33_DB \
    0b00000011  //  2     0                                        33 dB (default)
#define RADIOLIB_CC1101_MAGN_TARGET_36_DB \
    0b00000100  //  2     0                                        36 dB
#define RADIOLIB_CC1101_MAGN_TARGET_38_DB \
    0b00000101  //  2     0                                        38 dB
#define RADIOLIB_CC1101_MAGN_TARGET_40_DB \
    0b00000110  //  2     0                                        40 dB
#define RADIOLIB_CC1101_MAGN_TARGET_42_DB \
    0b00000111  //  2     0                                        42 dB

// RADIOLIB_CC1101_REG_AGCCTRL1
#define RADIOLIB_CC1101_AGC_LNA_PRIORITY_LNA2 \
    0b00000000  //  6     6   LNA priority setting: LNA2 first
#define RADIOLIB_CC1101_AGC_LNA_PRIORITY_LNA \
    0b01000000  //  6     6                         LNA first (default)
#define RADIOLIB_CC1101_CARRIER_SENSE_REL_THR_OFF \
    0b00000000  //  5     4   RSSI relative change to assert carrier sense: disabled (default)
...
#define RADIOLIB_CC1101_CARRIER_SENSE_ABS_THR \
    0x00  //  3     0   RSSI threshold to assert carrier sense in 2s compliment, Thr = MAGN_TARGET +
          //  CARRIER_SENSE_ABS_TH [dB]
...
#define RADIOLIB_CC1101_HYST_LEVEL_MEDIUM \
    0b10000000  //  7     6                         medium (default)
...
#define RADIOLIB_CC1101_WAIT_TIME_16_SAMPLES \
    0b00010000  //  5     4                  16 samples (default)
...
#define RADIOLIB_CC1101_AGC_FREEZE_SYNC_WORD \
    0b00000100  //  3     2                    when sync word is found
#define RADIOLIB_CC1101_AGC_FREEZE_MANUAL_A \
    0b00001000  //  3     2                    manually freeze analog control
#define RADIOLIB_CC1101_AGC_FREEZE_MANUAL_AD \
    0b00001100  //  3     2                    manually freeze analog and digital control
#define RADIOLIB_CC1101_FILTER_LENGTH_8 \
    0b00000000  //  1     0   averaging length for channel filter: 8 samples
#define RADIOLIB_CC1101_FILTER_LENGTH_16 \
    0b00000001  //  1     0                                        16 samples (default)
#define RADIOLIB_CC1101_FILTER_LENGTH_32 \
    0b00000010  //  1     0                                        32 samples
#define RADIOLIB_CC1101_FILTER_LENGTH_64 \
    0b00000011  //  1     0                                        64 samples
#define RADIOLIB_CC1101_ASK_OOK_BOUNDARY_4_DB \
    0b00000000  //  1     0   ASK/OOK decision boundary: 4 dB
#define RADIOLIB_CC1101_ASK_OOK_BOUNDARY_8_DB \
    0b00000001  //  1     0                              8 dB (default)
#define RADIOLIB_CC1101_ASK_OOK_BOUNDARY_12_DB \
    0b00000010  //  1     0                              12 dB
#define RADIOLIB_CC1101_ASK_OOK_BOUNDARY_16_DB \
    0b00000011  //  1     0                              16 dB

// RADIOLIB_CC1101_REG_WOREVT1 + REG_WOREVT0
#define RADIOLIB_CC1101_EVENT0_TIMEOUT_MSB \
    0x87  //  7     0   EVENT0 timeout: t_event0 = (750 / f(XOSC)) * EVENT0_TIMEOUT * 2^(5 *
          //  WOR_RES) [s]
#define RADIOLIB_CC1101_EVENT0_TIMEOUT_LSB \
    0x6B  //  7     0       default value for 26 MHz crystal: 1.0 s
...
#define RADIOLIB_CC1101_EVENT1_TIMEOUT_48 \
    0b01110000                                 //  6     4                   48 RC periods (default)
#define RADIOLIB_CC1101_RC_CAL_OFF 0b00000000  //  3     3   disable RC oscillator calibration
#define RADIOLIB_CC1101_RC_CAL_ON \
    0b00001000  //  3     3   enable RC oscillator calibration (default)
...
#define RADIOLIB_CC1101_CHP_CURR_CAL_ON \
    0b00100000  //  5     4   enable charge pump calibration (default)
#define RADIOLIB_CC1101_FSCAL3 \
    0x09  //  3     0   charge pump output current: I_out = I_0 * 2^(FSCAL3/4) [A]
...
#define RADIOLIB_CC1101_TEMP_SENS_IDLE_OFF \
    0x7F  //  7     0   temperature sensor will not be available in idle mode (default)
#define RADIOLIB_CC1101_TEMP_SENS_IDLE_ON \
    0xBF  //  7     0   temperature sensor will be available in idle mode

// RADIOLIB_CC1101_REG_TEST0
#define RADIOLIB_CC1101_VCO_SEL_CAL_OFF \
    0b00000000  //  1     1   disable VCO selection calibration stage
#define RADIOLIB_CC1101_VCO_SEL_CAL_ON \
    0b00000010  //  1     1   enable VCO selection calibration stage
...
#define RADIOLIB_CC1101_MARC_STATE_TXRX_SWITCH \
    0x10  //  4     0                             TXRX_SWITCH
#define RADIOLIB_CC1101_MARC_STATE_RXFIFO_OVERFLOW \
    0x11  //  4     0                             RXFIFO_OVERFLOW
...
#define RADIOLIB_CC1101_MARC_STATE_RXTX_SWITCH \
    0x15  //  4     0                             RXTX_SWITCH
#define RADIOLIB_CC1101_MARC_STATE_TXFIFO_UNDERFLOW \
    0x16  //  4     0                             TXFIFO_UNDERFLOW
...
class CC1101 : public PhysicalLayer
{
  public:
    ...
    */
    ...
    /*!
      \brief Stops direct mode. It is required to call this method to switch from direct
      transmissions to packet-based transmissions.
    */
    int16_t packetMode();
    ...
    */
    ...
    /*!
      \brief Reads data received after calling startReceive method. When the packet length is not
      known in advance, getPacketLength method must be called BEFORE calling readData! \param data
      Pointer to array to save the received binary data. \param len Number of bytes that will be
      read. When set to 0, the packet length will be retreived automatically. When more bytes than
      received are requested, only the number of bytes requested will be returned. \returns \ref
      status_codes
    */
    ...
    */
    ...
    /*!
      ...
      \param preambleLength Preamble length to be set (in bits), allowed values: 16, 24, 32, 48, 64,
      96, 128 and 192. \returns \ref status_codes
    */
    int16_t setPreambleLength(uint8_t preambleLength, uint8_t qualityThreshold);

    /*!
      \brief Sets node and broadcast addresses. Calling this method will also enable address
      filtering. \param nodeAddr Node address to be set. \param numBroadcastAddrs Number of
      broadcast addresses to be used. Can be set to 0 (no broadcast), 1 (broadcast at 0x00) or 2
      (broadcast at 0x00 and 0xFF). \returns \ref status_codes
    */
    int16_t setNodeAddress(uint8_t nodeAddr, uint8_t numBroadcastAddrs = 0);

    /*!
      \brief Disables address filtering. Calling this method will also erase previously set
      addresses. \returns \ref status_codes
    */
   ...
   */
    ...
    /*!
     \brief Set modem in "sniff" mode: no packet filtering (e.g., no preamble, sync word, address,
     CRC). \param enable Set or unset promiscuous mode. \returns \ref status_codes
   */
   ...
   */
    ...
    */
    ...
    /*!
      ...
      RADIOLIB_ENCODING_MANCHESTER, and RADIOLIB_ENCODING_WHITENING. Note that encoding on CC1101 is
      applied to the entire stream including preamble, sync word, and CRC. \param encoding Encoding
      to be used. \returns \ref status_codes
    */
   ...
   */
    ...
    /*!
      \brief Set interrupt service routine function to call when data bit is receveid in direct
  ...
  protected:
    ...
    static void getExpMant(float target, uint16_t mantOffset, uint8_t divExp, uint8_t expMax,
                           uint8_t& exp, uint8_t& mant);
