...
#define RADIOLIB_RF69_LISTEN_ABORT \
    0b00100000  //  5     5   abort Listen mode (has to be set together with RF69_LISTEN_OFF)
...
#define RADIOLIB_RF69_CONTINUOUS_MODE_WITH_SYNC \
    0b01000000  //  6     5   continuous mode with bit synchronizer
#define RADIOLIB_RF69_CONTINUOUS_MODE \
    0b01100000                               //  6     5   continuous mode without bit synchronizer
...
#define RADIOLIB_RF69_FSK_GAUSSIAN_1_0 \
    0b00000001  //  1     0                       FSK modulation Gaussian filter, BT = 1.0
#define RADIOLIB_RF69_FSK_GAUSSIAN_0_5 \
    0b00000010  //  1     0                       FSK modulation Gaussian filter, BT = 0.5
#define RADIOLIB_RF69_FSK_GAUSSIAN_0_3 \
    0b00000011  //  1     0                       FSK modulation Gaussian filter, BT = 0.3
#define RADIOLIB_RF69_OOK_FILTER_BR \
    0b00000001  //  1     0                       OOK modulation filter, f_cutoff = BR
#define RADIOLIB_RF69_OOK_FILTER_2BR \
    0b00000010  //  1     0                       OOK modulation filter, f_cutoff = 2*BR
...
#define RADIOLIB_RF69_FRF_MSB \
    0xE4  //  7     0   carrier frequency setting: f_RF = (F(XOSC) * FRF)/2^19
...
#define RADIOLIB_RF69_RC_CAL_RUNNING \
    0b00000000  //  6     6   RC oscillator calibration is still running
...
#define RADIOLIB_RF69_AFC_LOW_BETA_ON \
    0b00100000  //  5     5   improved AFC routine for signals with modulation index less than 2

// RADIOLIB_RF69_REG_LISTEN_1
#define RADIOLIB_RF69_LISTEN_RES_IDLE_64_US \
    0b01000000  //  7     6   resolution of Listen mode idle time: 64 us
#define RADIOLIB_RF69_LISTEN_RES_IDLE_4_1_MS \
    0b10000000  //  7     6                                        4.1 ms (default)
#define RADIOLIB_RF69_LISTEN_RES_IDLE_262_MS \
    0b11000000  //  7     6                                        262 ms
#define RADIOLIB_RF69_LISTEN_RES_RX_64_US \
    0b00010000  //  5     4   resolution of Listen mode rx time: 64 us (default)
#define RADIOLIB_RF69_LISTEN_RES_RX_4_1_MS \
    0b00100000  //  5     4                                      4.1 ms
#define RADIOLIB_RF69_LISTEN_RES_RX_262_MS \
    0b00110000  //  5     4                                      262 ms
...
#define RADIOLIB_RF69_LISTEN_ACCEPT_MATCH_SYNC_ADDRESS \
    0b00001000  //  3     3                               RSSI above threshold AND sync address
                //  matched
#define RADIOLIB_RF69_LISTEN_END_KEEP_RX \
    0b00000000  //  2     1   action after packet acceptance: stay in Rx mode
#define RADIOLIB_RF69_LISTEN_END_KEEP_RX_TIMEOUT \
    0b00000010  //  2     1                                   stay in Rx mode until timeout
                //  (default)
#define RADIOLIB_RF69_LISTEN_END_KEEP_RX_TIMEOUT_RESUME \
    0b00000100  //  2     1                                   stay in Rx mode until timeout, Listen
                //  mode will resume
...
#define RADIOLIB_RF69_OUTPUT_POWER \
    0b00011111  //  4     0   output power: P_out = -18 + OUTPUT_POWER
...
#define RADIOLIB_RF69_PA_RAMP_40_US \
...
#define RADIOLIB_RF69_OCP_TRIM \
    0b00001010  //  3     0   OCP current: I_max(OCP_TRIM = 0b1010) = 95 mA
...
#define RADIOLIB_RF69_LNA_GAIN_AUTO \
    0b00000000  //  2     0   LNA gain setting: set automatically by AGC
...
#define RADIOLIB_RF69_LNA_GAIN_MAX_12_DB \
    0b00000011  //  2     0                     max gain - 12 dB
#define RADIOLIB_RF69_LNA_GAIN_MAX_24_DB \
    0b00000100  //  2     0                     max gain - 24 dB
#define RADIOLIB_RF69_LNA_GAIN_MAX_36_DB \
    0b00000101  //  2     0                     max gain - 36 dB
#define RADIOLIB_RF69_LNA_GAIN_MAX_48_DB \
    0b00000110  //  2     0                     max gain - 48 dB

// RADIOLIB_RF69_REG_RX_BW
#define RADIOLIB_RF69_DCC_FREQ \
    0b01000000  //  7     5   DC offset canceller cutoff frequency (4% Rx BW by default)
#define RADIOLIB_RF69_RX_BW_MANT_16 \
    0b00000000  //  4     3   Channel filter bandwidth FSK: RxBw = F(XOSC)/(RxBwMant * 2^(RxBwExp +
                //  2))
#define RADIOLIB_RF69_RX_BW_MANT_20 \
    0b00001000  //  4     3                            OOK: RxBw = F(XOSC)/(RxBwMant * 2^(RxBwExp +
                //  3))
...
#define RADIOLIB_RF69_DCC_RX_BW_MANT_AFC \
    0b00001000                                      //  4     3   default RxBwMant parameter for AFC
...
#define RADIOLIB_RF69_OOK_PEAK_THRESH_STEP_0_5_DB \
    0b00000000  //  5     3   OOK demodulator step size: 0.5 dB (default)
#define RADIOLIB_RF69_OOK_PEAK_THRESH_STEP_1_0_DB \
    0b00001000  //  5     3                              1.0 dB
#define RADIOLIB_RF69_OOK_PEAK_THRESH_STEP_1_5_DB \
    0b00010000  //  5     3                              1.5 dB
#define RADIOLIB_RF69_OOK_PEAK_THRESH_STEP_2_0_DB \
    0b00011000  //  5     3                              2.0 dB
#define RADIOLIB_RF69_OOK_PEAK_THRESH_STEP_3_0_DB \
    0b00100000  //  5     3                              3.0 dB
#define RADIOLIB_RF69_OOK_PEAK_THRESH_STEP_4_0_DB \
    0b00101000  //  5     3                              4.0 dB
#define RADIOLIB_RF69_OOK_PEAK_THRESH_STEP_5_0_DB \
    0b00110000  //  5     3                              5.0 dB
#define RADIOLIB_RF69_OOK_PEAK_THRESH_STEP_6_0_DB \
    0b00111000  //  5     3                              6.0 dB
...
#define RADIOLIB_RF69_OOK_AVG_THRESH_FILT_8_PI \
    0b01000000  //  7     6                                   chip rate / 8*pi
#define RADIOLIB_RF69_OOK_AVG_THRESH_FILT_4_PI \
    0b10000000  //  7     6                                   chip rate / 4*pi (default)
#define RADIOLIB_RF69_OOK_AVG_THRESH_FILT_2_PI \
    0b11000000  //  7     6                                   chip rate / 2*pi
...
#define RADIOLIB_RF69_IRQ_FIFO_LEVEL \
    0b00100000  //  5     5   FIFO contains more than FifoThreshold bytes
...
#define RADIOLIB_RF69_IRQ_PAYLOAD_READY \
    0b00000100  //  2     2   last payload byte received and CRC check passed
...
#define RADIOLIB_RF69_TIMEOUT_RX_START_OFF \
    0x00  //  7     0   RSSI interrupt timeout disabled (default)
#define RADIOLIB_RF69_TIMEOUT_RX_START \
    0xFF  //  7     0   timeout will occur if RSSI interrupt is not received

// RADIOLIB_RF69_REG_RX_TIMEOUT_2
#define RADIOLIB_RF69_TIMEOUT_RSSI_THRESH_OFF \
    0x00  //  7     0   PayloadReady interrupt timeout disabled (default)
#define RADIOLIB_RF69_TIMEOUT_RSSI_THRESH \
    0xFF  //  7     0   timeout will occur if PayloadReady interrupt is not received
...
#define RADIOLIB_RF69_FIFO_FILL_CONDITION_SYNC \
    0b00000000  //  6     6   FIFO fill condition: on SyncAddress interrupt (default)
#define RADIOLIB_RF69_FIFO_FILL_CONDITION \
    0b01000000  //  6     6                        as long as the bit is set
...
#define RADIOLIB_RF69_ENTER_COND_NONE \
    0b00000000  //  7     5   condition for entering intermediate mode: none, AutoModes disabled
                //  (default)
#define RADIOLIB_RF69_ENTER_COND_FIFO_NOT_EMPTY \
    0b00100000  //  7     5                                             FifoNotEmpty rising edge
#define RADIOLIB_RF69_ENTER_COND_FIFO_LEVEL \
    0b01000000  //  7     5                                             FifoLevel rising edge
#define RADIOLIB_RF69_ENTER_COND_CRC_OK \
    0b01100000  //  7     5                                             CrcOk rising edge
#define RADIOLIB_RF69_ENTER_COND_PAYLOAD_READY \
    0b10000000  //  7     5                                             PayloadReady rising edge
#define RADIOLIB_RF69_ENTER_COND_SYNC_ADDRESS \
    0b10100000  //  7     5                                             SyncAddress rising edge
#define RADIOLIB_RF69_ENTER_COND_PACKET_SENT \
    0b11000000  //  7     5                                             PacketSent rising edge
#define RADIOLIB_RF69_ENTER_COND_FIFO_EMPTY \
    0b11100000  //  7     5                                             FifoNotEmpty falling edge
#define RADIOLIB_RF69_EXIT_COND_NONE \
    0b00000000  //  4     2   condition for exiting intermediate mode: none, AutoModes disabled
                //  (default)
#define RADIOLIB_RF69_EXIT_COND_FIFO_EMPTY \
    0b00100000  //  4     2                                            FifoNotEmpty falling edge
#define RADIOLIB_RF69_EXIT_COND_FIFO_LEVEL \
    0b01000000  //  4     2                                            FifoLevel rising edge
#define RADIOLIB_RF69_EXIT_COND_CRC_OK \
    0b01100000  //  4     2                                            CrcOk rising edge
#define RADIOLIB_RF69_EXIT_COND_PAYLOAD_READY \
    0b10000000  //  4     2                                            PayloadReady rising edge
#define RADIOLIB_RF69_EXIT_COND_SYNC_ADDRESS \
    0b10100000  //  4     2                                            SyncAddress rising edge
#define RADIOLIB_RF69_EXIT_COND_PACKET_SENT \
    0b11000000  //  4     2                                            PacketSent rising edge
#define RADIOLIB_RF69_EXIT_COND_TIMEOUT \
    0b11100000  //  4     2                                            timeout rising edge
...
#define RADIOLIB_RF69_TX_START_CONDITION_FIFO_NOT_EMPTY \
    0b10000000  //  7     7                                        FifoNotEmpty (default)
#define RADIOLIB_RF69_FIFO_THRESH \
    0x1F  //  6     0   default threshold to trigger FifoLevel interrupt
...
#define RADIOLIB_RF69_AES_ON \
    0b00000001  //  0     0   AES encryption enabled, payload size limited to 66 bytes
...
#define RADIOLIB_RF69_TEMP_MEAS_RUNNING \
    0b00000100  //  2     2   temperature measurement status: on-going
#define RADIOLIB_RF69_TEMP_MEAS_DONE 0b00000000  //  2     2                                   done

// RADIOLIB_RF69_REG_TEST_DAGC
#define RADIOLIB_RF69_CONTINUOUS_DAGC_NORMAL \
    0x00  //  7     0   fading margin improvement: normal mode
...
#define RADIOLIB_RF69_CONTINUOUS_DAGC_LOW_BETA_OFF \
    0x30  //  7     0                              improved mode for AfcLowBetaOff (default)
...
class RF69 : public PhysicalLayer
{
  public:
    ...
    */
    int16_t begin(float freq = RADIOLIB_RF69_DEFAULT_FREQ, float br = RADIOLIB_RF69_DEFAULT_BR,
                  ...
                  float rxBw = RADIOLIB_RF69_DEFAULT_RXBW, int8_t pwr = RADIOLIB_RF69_DEFAULT_POWER,
    ...
    */
    ...
    /*!
      \brief Sets carrier frequency. Allowed values are in bands 290.0 to 340.0 MHz, 431.0 to 510.0
      MHz and 862.0 to 1020.0 MHz. \param freq Carrier frequency to be set in MHz. \returns \ref
      status_codes
    */
    ...
    */
    ...
    /*!
      ...
      are 2.6, 3.1, 3.9, 5.2, 6.3, 7.8, 10.4, 12.5, 15.6, 20.8, 25.0, 31.3, 41.7, 50.0, 62.5, 83.3,
      100.0, 125.0, 166.7, 200.0, 250.0, 333.3, 400.0 and 500.0 kHz. \param rxBw Receiver bandwidth
    ...
    */
    ...
    /*!
      ...
      \param preambleLen Preamble length to be set (in bits), allowed values: 16, 24, 32, 48, 64,
    ...
    */
    ...
    /*!
      \brief Sets broadcast address. Calling this method will also enable address filtering for node
      and broadcast address. \param broadAddr Node address to be set. \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      \brief Enables/disables OOK modulation instead of FSK.
       Note: This function calls setRxBandwidth again, since register values differ based on OOK
      mode being enabled/disabled. \param enable Enable (true) or disable (false) OOK. \returns \ref
      status_codes
    */
    ...
    /*!
      ...
      RADIOLIB_RF69_OOK_THRESH_FIXED or RADIOLIB_RF69_OOK_THRESH_AVERAGE \returns \ref status_codes
    */
   ...
   */
    ...
    /*!
      \brief Read version SPI register. Should return RF69_CHIP_VERSION (0x24) if SX127x is
      connected and working. \returns Version register contents or \ref status_codes
   */
